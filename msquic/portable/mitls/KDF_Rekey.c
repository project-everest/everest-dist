...
void KDF_Rekey_discard(bool uu____10)
{
  
}

void KDF_Rekey_print(Prims_string s)
{
  KDF_Rekey_discard(FStar_IO_debug_print_string(Prims_strcat("RKY| ", Prims_strcat(s, "\n"))));
}

exit_code KDF_Rekey_test_rekey()
{
  KDF_info
  a2 = { .ha = Spec_Hash_Definitions_SHA2_256, ._1 = { .tag = FStar_Pervasives_Native_None } };
  Prims_dtuple2__KDF_info_FStar_Bytes_bytes
  kdf2 = KDF_coerce(false, (void *)(uint8_t)0U, a2, Random_sample32((uint32_t)32U));
  KDF_info
  a1 = { .ha = Spec_Hash_Definitions_SHA2_256, ._1 = { .tag = FStar_Pervasives_Native_None } };
  uint32_t len_;
  switch (a1.ha)
  {
  ...
  KDF_info a0 = kdf2.fst;
  FStar_Bytes_bytes key0 = kdf2.snd;
  FStar_Bytes_bytes lb0 = FStar_Bytes_bytes_of_string("RE");
  FStar_Bytes_bytes raw = HKDF_expand(a0.ha, key0, lb0, len_);
  Prims_dtuple2__KDF_info_FStar_Bytes_bytes dk = KDF_coerce(false, (void *)(uint8_t)0U, a1, raw);
  Prims_dtuple2__KDF_info_FStar_Bytes_bytes scrut = dk;
  Prims_dtuple2__KDF_info_FStar_Bytes_bytes kdf1 = scrut;
  uint32_t a1_ = (uint32_t)32U;
  uint32_t len_0 = a1_;
  KDF_info a3 = kdf2.fst;
  FStar_Bytes_bytes key1 = kdf2.snd;
  FStar_Bytes_bytes lb1 = FStar_Bytes_bytes_of_string("IV");
  FStar_Bytes_bytes raw0 = HKDF_expand(a3.ha, key1, lb1, len_0);
  FStar_Bytes_bytes scrut0 = raw0;
  FStar_Bytes_bytes iv1 = scrut0;
  KDF_Rekey_print(Prims_strcat("IV1: ", FStar_Bytes_hex_of_bytes(iv1)));
  KDF_info
  a00 = { .ha = Spec_Hash_Definitions_SHA2_256, ._1 = { .tag = FStar_Pervasives_Native_None } };
  uint32_t len_1;
  switch (a00.ha)
  {
    case Spec_Hash_Definitions_MD5:
  ...
  KDF_info a4 = kdf1.fst;
  FStar_Bytes_bytes key2 = kdf1.snd;
  FStar_Bytes_bytes lb2 = FStar_Bytes_bytes_of_string("RE");
  FStar_Bytes_bytes raw1 = HKDF_expand(a4.ha, key2, lb2, len_1);
  Prims_dtuple2__KDF_info_FStar_Bytes_bytes
  dk0 = KDF_coerce(false, (void *)(uint8_t)0U, a00, raw1);
  Prims_dtuple2__KDF_info_FStar_Bytes_bytes scrut1 = dk0;
  uint32_t a0_ = (uint32_t)32U;
  uint32_t len_2 = a0_;
  KDF_info a = kdf1.fst;
  FStar_Bytes_bytes key = kdf1.snd;
  FStar_Bytes_bytes lb = FStar_Bytes_bytes_of_string("IV");
  FStar_Bytes_bytes raw2 = HKDF_expand(a.ha, key, lb, len_2);
  FStar_Bytes_bytes scrut2 = raw2;
  FStar_Bytes_bytes iv0 = scrut2;
  KDF_Rekey_print(Prims_strcat("IV0: ", FStar_Bytes_hex_of_bytes(iv0)));
  return EXIT_SUCCESS;
}
