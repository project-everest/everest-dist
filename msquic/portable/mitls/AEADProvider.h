...
#ifndef __AEADProvider_H
#define __AEADProvider_H
...
extern void (*AEADProvider_dbg)(Prims_string x0);

typedef TLSInfo_id AEADProvider_id;

EverCrypt_aead_alg AEADProvider_alg(TLSInfo_id i1);

EverCrypt_aead_alg AEADProvider_alg_(TLSInfo_id i1);

typedef struct FStar_Pervasives_Native_option__EverCrypt_aead_alg_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  EverCrypt_aead_alg v;
}
...
typedef struct K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes_s
{
  EverCrypt__aead_state *fst;
...
typedef Prims_int AEADProvider_plainlen;
...
#define __AEADProvider_H_DEFINED
#endif
