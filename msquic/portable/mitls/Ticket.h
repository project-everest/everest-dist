...
extern void (*Ticket_trace)(Prims_string x0);

typedef Prims_string Ticket_hostname;

typedef struct Ticket_ticket_key_s
{
  TLSInfo_id i;
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes wr;
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes rd;
}
Ticket_ticket_key;
...
typedef struct FStar_Pervasives_Native_option__Ticket_ticket_key_s
{
...
extern FStar_Pervasives_Native_option__Ticket_ticket_key *Ticket_ticket_enc;

extern FStar_Pervasives_Native_option__Ticket_ticket_key *Ticket_sealing_enc;
...
#define Ticket_Ticket12 0
#define Ticket_Ticket13 1

typedef uint8_t Ticket_ticket_tags;

typedef struct Ticket_ticket_s
{
  Ticket_ticket_tags tag;
  union {
    struct 
    {
    ...
    struct 
    {
      CipherSuite_cipherSuite_ cs;
      TLSInfo_logInfo li;
      TLSInfo_pre_rmsId *rmsId;
      FStar_Bytes_bytes rms;
      FStar_Bytes_bytes nonce;
      uint32_t ticket_created;
      uint32_t ticket_age_add;
      FStar_Bytes_bytes custom;
    }
    case_Ticket13;
  }
  val;
...
typedef struct Prims_dtuple2__TLSInfo_logInfo_TLSInfo_pre_rmsId_s
{
  TLSInfo_logInfo fst;
  TLSInfo_pre_rmsId *snd;
}
...
typedef struct FStar_Pervasives_Native_option__Ticket_ticket_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  Ticket_ticket v;
}
...
typedef LowParse_Slice_slice Ticket_slice;
...
typedef struct K___HandshakeMessages_hrr_FStar_Bytes_bytes_FStar_Bytes_bytes_s
{
  HandshakeMessages_hrr fst;
  FStar_Bytes_bytes snd;
  FStar_Bytes_bytes thd;
}
K___HandshakeMessages_hrr_FStar_Bytes_bytes_FStar_Bytes_bytes;

typedef struct
FStar_Pervasives_Native_option__K___HandshakeMessages_hrr_FStar_Bytes_bytes_FStar_Bytes_bytes_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  K___HandshakeMessages_hrr_FStar_Bytes_bytes_FStar_Bytes_bytes v;
}
...
Ticket_check_ticket13(FStar_Bytes_bytes b);

typedef struct
K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_TLSInfo_msId_FStar_Bytes_bytes_s
{
...
K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_TLSInfo_msId_FStar_Bytes_bytes;

typedef struct
FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_TLSInfo_msId_FStar_Bytes_bytes_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_TLSInfo_msId_FStar_Bytes_bytes
  v;
