...
Ticket_ticket_decrypt(bool seal, FStar_Bytes_bytes cipher)
{
  ...
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes rd = scrut0.rd;
...
FStar_Bytes_bytes Ticket_ticket_encrypt(bool seal, FStar_Bytes_bytes plain)
{
  ...
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes wr = scrut.wr;
