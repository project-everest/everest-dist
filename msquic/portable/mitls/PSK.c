...
)
{
  ...
  else if (r->tag == Prims_Cons)
  {
    ...
    if (__eq__Prims_string(x, x_))
      ...
      return FStar_Monotonic_DependentMap_sel__Prims_string_FStar_Bytes_bytes(tl1, x);
  }
  else
  {
  ...
  else if (r->tag == Prims_Cons)
  {
    ...
    *tl1 = r->tl;
    ...
    if (__eq__FStar_Bytes_bytes(x, x_))
      ...
      return
        FStar_Monotonic_DependentMap_sel__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes(tl1,
          x);
  }
  else
  {
  ...
  else if (r->tag == Prims_Cons)
  {
    ...
    *tl1 = r->tl;
    ...
    if (__eq__FStar_Bytes_bytes(x, x_))
      ...
      return
        FStar_Monotonic_DependentMap_sel__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool(tl1,
          x);
  }
  else
  {
