...
static FStar_Pervasives_Native_option__K___uint8_t_uint32_t
Format_Constants_constantByte_parser32(uint8_t c, FStar_Bytes_bytes input)
{
...
static FStar_Bytes_bytes Format_Constants_constantByte_serializer32(uint8_t c, uint8_t input)
{
  return LowParse_SLow_Int_serialize32_u8(input);
}

FStar_Bytes_bytes
FStar_Pervasives_Native_fst__FStar_Bytes_bytes_FStar_Bytes_bytes(
...
FStar_Bytes_bytes
FStar_Pervasives_Native_snd__FStar_Bytes_bytes_FStar_Bytes_bytes(
  K___FStar_Bytes_bytes_FStar_Bytes_bytes x
)
{
  return x.snd;
...
typedef struct K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes_s
{
  uint8_t fst;
  K___FStar_Bytes_bytes_FStar_Bytes_bytes snd;
}
K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes;

static Format_UncompressedPointRepresentation_uncompressedPointRepresentation
Format_UncompressedPointRepresentation_ucp_of_cuv(
  uint32_t l,
  K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes cuv
)
{
  K___FStar_Bytes_bytes_FStar_Bytes_bytes uv = cuv.snd;
  return
    (
      (Format_UncompressedPointRepresentation_uncompressedPointRepresentation){
        .legacy_form = (uint8_t)4U,
        .x = FStar_Pervasives_Native_fst__FStar_Bytes_bytes_FStar_Bytes_bytes(uv),
        .y = FStar_Pervasives_Native_snd__FStar_Bytes_bytes_FStar_Bytes_bytes(uv)
      }
    );
}

static K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes
Format_UncompressedPointRepresentation_cuv_of_ucp(
  uint32_t l,
  Format_UncompressedPointRepresentation_uncompressedPointRepresentation ucp
)
{
  return
    (
      (K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes){
        .fst = (uint8_t)4U,
        .snd = { .fst = ucp.x, .snd = ucp.y }
      }
    );
}

typedef struct K___K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes_uint32_t_s
{
  K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes fst;
  uint32_t snd;
}
K___K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes_uint32_t;

typedef struct
FStar_Pervasives_Native_option__K___K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes_uint32_t_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  K___K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes_uint32_t v;
}
FStar_Pervasives_Native_option__K___K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes_uint32_t;

FStar_Pervasives_Native_option__K___Format_UncompressedPointRepresentation_uncompressedPointRepresentation_uint32_t
Format_UncompressedPointRepresentation_uncompressedPointRepresentation_parser32(
  uint32_t coordinate_length,
  FStar_Bytes_bytes input
)
{
  FStar_Pervasives_Native_option__K___uint8_t_uint32_t
  scrut0 = Format_Constants_constantByte_parser32((uint8_t)4U, input);
  FStar_Pervasives_Native_option__K___K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes_uint32_t
  scrut1;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    ...
    if (FStar_Bytes_len(input_) < coordinate_length)
      scrut0 =
        (
    ...
    {
      FStar_Bytes_bytes s_ = FStar_Bytes_slice(input_, (uint32_t)0U, coordinate_length);
      scrut0 =
        (
          (FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
            .v = { .fst = s_, .snd = coordinate_length }
          }
        );
    }
    FStar_Pervasives_Native_option__K___K___FStar_Bytes_bytes_FStar_Bytes_bytes_uint32_t scrut2;
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t l1 = scrut0.v.snd;
      FStar_Bytes_bytes v2 = scrut0.v.fst;
      ...
      if (FStar_Bytes_len(input_1) < coordinate_length)
        scrut =
          (
            (FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t){
              .tag = FStar_Pervasives_Native_None
      ...
      {
        FStar_Bytes_bytes s_ = FStar_Bytes_slice(input_1, (uint32_t)0U, coordinate_length);
        scrut =
          (
            (FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
    ...
    if (scrut2.tag == FStar_Pervasives_Native_Some)
    {
      ...
      K___FStar_Bytes_bytes_FStar_Bytes_bytes v_ = scrut2.v.fst;
      scrut1 =
        (
          (FStar_Pervasives_Native_option__K___K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
  ...
  if (scrut1.tag == FStar_Pervasives_Native_Some)
  {
    ...
    K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes v1 = scrut1.v.fst;
    return
      (
        (FStar_Pervasives_Native_option__K___Format_UncompressedPointRepresentation_uncompressedPointRepresentation_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = {
            .fst = Format_UncompressedPointRepresentation_ucp_of_cuv(coordinate_length, v1),
            .snd = consumed
          }
        }
      );
...
FStar_Bytes_bytes
Format_UncompressedPointRepresentation_uncompressedPointRepresentation_serializer32(
  uint32_t coordinate_length,
  Format_UncompressedPointRepresentation_uncompressedPointRepresentation input
)
{
  K___uint8_t_K___FStar_Bytes_bytes_FStar_Bytes_bytes
  x = Format_UncompressedPointRepresentation_cuv_of_ucp(coordinate_length, input);
  uint8_t fs = x.fst;
  K___FStar_Bytes_bytes_FStar_Bytes_bytes sn = x.snd;
  FStar_Bytes_bytes output1 = Format_Constants_constantByte_serializer32((uint8_t)4U, fs);
  FStar_Bytes_bytes fs1 = sn.fst;
  FStar_Bytes_bytes sn1 = sn.snd;
  FStar_Bytes_bytes output11 = fs1;
  FStar_Bytes_bytes output2 = sn1;
  FStar_Bytes_bytes output20 = FStar_Bytes_append(output11, output2);
  return FStar_Bytes_append(output1, output20);
}

typedef struct K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes_s
{
  Parsers_NamedGroup_namedGroup fst;
  FStar_Bytes_bytes snd;
}
K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes;

static Parsers_NamedGroup_namedGroup
FStar_Pervasives_Native_fst__Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes(
  K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes x
)
{
  return x.fst;
}
...
FStar_Pervasives_Native_snd__Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes(
  K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes x
)
{
  return x.snd;
...
typedef struct K___K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes_uint32_t_s
{
  K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes fst;
  uint32_t snd;
}
K___K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes_uint32_t;

typedef struct
FStar_Pervasives_Native_option__K___K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes_uint32_t_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  K___K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes_uint32_t v;
}
FStar_Pervasives_Native_option__K___K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes_uint32_t;

FStar_Pervasives_Native_option__K___Format_KeyShareEntry_keyShareEntry_uint32_t
Format_KeyShareEntry_keyShareEntry_parser32(FStar_Bytes_bytes input)
{
  FStar_Pervasives_Native_option__K___Parsers_NamedGroup_namedGroup_uint32_t
  scrut0 = Parsers_NamedGroup_namedGroup_parser32(input);
  FStar_Pervasives_Native_option__K___K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes_uint32_t
  scrut1;
  if (scrut0.tag == FStar_Pervasives_Native_Some)
  {
    uint32_t l = scrut0.v.snd;
    Parsers_NamedGroup_namedGroup v1 = scrut0.v.fst;
    FStar_Bytes_bytes input_ = FStar_Bytes_slice(input, l, FStar_Bytes_len(input));
    ...
    if (scrut0.tag == FStar_Pervasives_Native_Some)
    {
      ...
      uint32_t v2 = scrut0.v.fst;
      if (!(v2 < (uint32_t)1U || (uint32_t)65535U < v2))
        scrut2 =
          (
            (FStar_Pervasives_Native_option__K___uint32_t_uint32_t){
              .tag = FStar_Pervasives_Native_Some,
    ...
    if (scrut2.tag == FStar_Pervasives_Native_Some)
    {
      uint32_t l1 = scrut2.v.snd;
      uint32_t v2 = scrut2.v.fst;
      FStar_Bytes_bytes input_1 = FStar_Bytes_slice(input_, l1, FStar_Bytes_len(input_));
      FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t scrut;
      if (FStar_Bytes_len(input_1) < v2)
        scrut =
          (
            (FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t){
              .tag = FStar_Pervasives_Native_None
        ...
        res =
          {
            .tag = FStar_Pervasives_Native_Some,
            .v = {
              .fst = FStar_Bytes_slice(input_1, (uint32_t)0U, v2),
              .snd = FStar_Bytes_len(FStar_Bytes_slice(input_1, (uint32_t)0U, v2))
            }
          };
        if (res.tag == FStar_Pervasives_Native_Some)
        {
          uint32_t consumed = res.v.snd;
          FStar_Bytes_bytes v3 = res.v.fst;
          if (consumed == v2)
            scrut =
              (
                (FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t){
                  .tag = FStar_Pervasives_Native_Some,
                  .v = { .fst = v3, .snd = consumed }
                }
              );
          else
            scrut =
    ...
    if (scrut3.tag == FStar_Pervasives_Native_Some)
    {
      ...
      FStar_Bytes_bytes x = scrut3.v.fst;
      res =
        (
          (FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
    ...
    if (scrut4.tag == FStar_Pervasives_Native_Some)
    {
      ...
      FStar_Bytes_bytes v11 = scrut4.v.fst;
      scrut =
        (
          (FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_uint32_t){
            .tag = FStar_Pervasives_Native_Some,
  ...
  {
    uint32_t consumed = scrut1.v.snd;
    K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes v1 = scrut1.v.fst;
    return
      (
        (FStar_Pervasives_Native_option__K___Format_KeyShareEntry_keyShareEntry_uint32_t){
          .tag = FStar_Pervasives_Native_Some,
          .v = {
            .fst = {
              .group = FStar_Pervasives_Native_fst__Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes(v1),
              .key_exchange = FStar_Pervasives_Native_snd__Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes(v1)
            },
            .snd = consumed
          }
        }
...
FStar_Bytes_bytes
Format_KeyShareEntry_keyShareEntry_serializer32(Format_KeyShareEntry_keyShareEntry input)
{
  K___Parsers_NamedGroup_namedGroup_FStar_Bytes_bytes
  x = { .fst = input.group, .snd = input.key_exchange };
  Parsers_NamedGroup_namedGroup fs = x.fst;
  FStar_Bytes_bytes sn = x.snd;
  FStar_Bytes_bytes output1 = Parsers_NamedGroup_namedGroup_serializer32(fs);
  FStar_Bytes_bytes x1 = sn;
  FStar_Bytes_bytes pl = x1;
