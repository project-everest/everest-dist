...
FStar_List_Tot_Base_for_all__FStar_Bytes_bytes___Prims_list_Extensions_extension_(
  bool (*f)(K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ x0),
  Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *l
)
{
  if (l->tag == Prims_Nil)
    return true;
  else if (l->tag == Prims_Cons)
  {
    ...
    if (f(hd1))
      return
        FStar_List_Tot_Base_for_all__FStar_Bytes_bytes___Prims_list_Extensions_extension_(f,
          tl1);
    else
      return false;
  }
