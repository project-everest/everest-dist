...
#ifndef __HandshakeMessages_H
#define __HandshakeMessages_H
...
#define HandshakeMessages_HT_hello_request 0
#define HandshakeMessages_HT_client_hello 1
#define HandshakeMessages_HT_server_hello 2
#define HandshakeMessages_HT_session_ticket 3
#define HandshakeMessages_HT_end_of_early_data 4
#define HandshakeMessages_HT_hello_retry_request 5
#define HandshakeMessages_HT_encrypted_extensions 6
#define HandshakeMessages_HT_certificate 7
#define HandshakeMessages_HT_server_key_exchange 8
#define HandshakeMessages_HT_certificate_request 9
#define HandshakeMessages_HT_server_hello_done 10
#define HandshakeMessages_HT_certificate_verify 11
#define HandshakeMessages_HT_client_key_exchange 12
#define HandshakeMessages_HT_finished 13
#define HandshakeMessages_HT_key_update 14
#define HandshakeMessages_HT_message_hash 15

typedef uint8_t HandshakeMessages_handshakeType;
...
bool
HandshakeMessages_uu___is_HT_certificate_verify(HandshakeMessages_handshakeType projectee);
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_handshakeType_s
{
  ...
  union {
    ...
    HandshakeMessages_handshakeType case_Correct;
  }
  val;
}
...
typedef struct HandshakeMessages_ch_s
{
  Parsers_ProtocolVersion_protocolVersion ch_protocol_version;
  FStar_Bytes_bytes ch_client_random;
  FStar_Bytes_bytes ch_sessionID;
  Prims_list__Parsers_CipherSuite_cipherSuite *ch_cipher_suites;
  Prims_list__Parsers_CompressionMethod_compressionMethod *ch_compressions;
  FStar_Pervasives_Native_option__Prims_list__Extensions_extension_ ch_extensions;
}
...
typedef struct HandshakeMessages_sh_s
{
  Parsers_ProtocolVersion_protocolVersion sh_protocol_version;
  FStar_Bytes_bytes sh_server_random;
  FStar_Bytes_bytes sh_sessionID;
  Parsers_CipherSuite_cipherSuite sh_cipher_suite;
  Parsers_CompressionMethod_compressionMethod sh_compression;
  FStar_Pervasives_Native_option__Prims_list__Extensions_extension_ sh_extensions;
}
...
typedef struct HandshakeMessages_hrr_s
{
  FStar_Bytes_bytes hrr_sessionID;
  Parsers_CipherSuite_cipherSuite hrr_cipher_suite;
  Prims_list__Extensions_extension_ *hrr_extensions;
}
...
#define HandshakeMessages_KEX_S_DHE 0
#define HandshakeMessages_KEX_S_RSA 1

typedef uint8_t HandshakeMessages_kex_s_tags;

typedef struct HandshakeMessages_kex_s_s
{
  HandshakeMessages_kex_s_tags tag;
  union {
    Prims_dtuple2__CommonDH_group__CommonDH_pre_share_ case_KEX_S_DHE;
    FStar_Bytes_bytes case_KEX_S_RSA;
  }
  val;
}
...
typedef struct Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare__s
{
  CommonDH_group_ fst;
  CommonDH_pre_keyshare_ snd;
}
Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare_;

#define HandshakeMessages_KEX_S_PRIV_DHE 0
#define HandshakeMessages_KEX_S_PRIV_RSA 1

typedef uint8_t HandshakeMessages_kex_s_priv_tags;

typedef struct HandshakeMessages_kex_s_priv_s
{
  HandshakeMessages_kex_s_priv_tags tag;
  union {
    Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare_ case_KEX_S_PRIV_DHE;
    FStar_Bytes_bytes case_KEX_S_PRIV_RSA;
  }
  val;
}
HandshakeMessages_kex_s_priv;
...
#define HandshakeMessages_KEX_C_DHE 0
#define HandshakeMessages_KEX_C_ECDHE 1
#define HandshakeMessages_KEX_C_RSA 2
#define HandshakeMessages_KEX_C_DH 3

typedef uint8_t HandshakeMessages_kex_c_tags;

typedef struct HandshakeMessages_kex_c_s
{
  HandshakeMessages_kex_c_tags tag;
  union {
    FStar_Bytes_bytes case_KEX_C_DHE;
    FStar_Bytes_bytes case_KEX_C_ECDHE;
    FStar_Bytes_bytes case_KEX_C_RSA;
  }
  val;
}
...
typedef HandshakeMessages_kex_c HandshakeMessages_cke;

HandshakeMessages_kex_c
HandshakeMessages___proj__Mkcke__item__cke_kex_c(HandshakeMessages_kex_c projectee);

typedef Prims_list__Extensions_extension_ *HandshakeMessages_ee;

typedef struct HandshakeMessages_cr_s
{
  Prims_list__TLSConstants_certType *cr_cert_types;
  FStar_Pervasives_Native_option__Prims_list__Parsers_SignatureScheme_signatureScheme
  cr_sig_algorithms;
  Prims_list__Prims_string *cr_certificate_authorities;
}
...
typedef HandshakeMessages_cr HandshakeMessages_cr13;

typedef Prims_list__FStar_Bytes_bytes *HandshakeMessages_crt;

Prims_list__FStar_Bytes_bytes
*HandshakeMessages___proj__Mkcrt__item__crt_chain(Prims_list__FStar_Bytes_bytes *projectee);

typedef struct HandshakeMessages_crt13_s
{
  FStar_Bytes_bytes crt_request_context;
  Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *crt_chain13;
}
...
typedef struct FStar_Pervasives_Native_option__Parsers_SignatureScheme_signatureScheme_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  Parsers_SignatureScheme_signatureScheme v;
}
FStar_Pervasives_Native_option__Parsers_SignatureScheme_signatureScheme;

typedef struct HandshakeMessages_signature_s
{
  FStar_Pervasives_Native_option__Parsers_SignatureScheme_signatureScheme sig_algorithm;
  FStar_Bytes_bytes sig_signature;
}
...
typedef struct HandshakeMessages_ske_s
{
  HandshakeMessages_kex_s ske_kex_s;
  HandshakeMessages_signature ske_signed_params;
}
...
typedef HandshakeMessages_signature HandshakeMessages_cv;

typedef FStar_Bytes_bytes HandshakeMessages_fin;

FStar_Bytes_bytes HandshakeMessages___proj__Mkfin__item__fin_vd(FStar_Bytes_bytes projectee);

typedef struct HandshakeMessages_sticket_s
{
  uint32_t sticket_lifetime;
  FStar_Bytes_bytes sticket_ticket;
}
...
typedef struct HandshakeMessages_sticket13_s
{
  uint32_t ticket13_lifetime;
  uint32_t ticket13_age_add;
  FStar_Bytes_bytes ticket13_nonce;
  FStar_Bytes_bytes ticket13_ticket;
  Prims_list__Extensions_extension_ *ticket13_extensions;
}
...
#define HandshakeMessages_ClientHello 0
#define HandshakeMessages_ServerHello 1
#define HandshakeMessages_CertificateVerify 2
#define HandshakeMessages_Finished 3
#define HandshakeMessages_ClientKeyExchange 4
#define HandshakeMessages_ServerKeyExchange 5
#define HandshakeMessages_ServerHelloDone 6
#define HandshakeMessages_Certificate 7
#define HandshakeMessages_CertificateRequest 8
#define HandshakeMessages_HelloRequest 9
#define HandshakeMessages_NewSessionTicket 10
#define HandshakeMessages_EndOfEarlyData 11
#define HandshakeMessages_EncryptedExtensions 12
#define HandshakeMessages_Certificate13 13
#define HandshakeMessages_CertificateRequest13 14
#define HandshakeMessages_HelloRetryRequest 15
#define HandshakeMessages_NewSessionTicket13 16
#define HandshakeMessages_KeyUpdate 17
#define HandshakeMessages_Binders 18
#define HandshakeMessages_MessageHash 19

typedef uint8_t HandshakeMessages_hs_msg_tags;

typedef struct HandshakeMessages_hs_msg_s
{
  HandshakeMessages_hs_msg_tags tag;
  union {
    HandshakeMessages_ch case_ClientHello;
    HandshakeMessages_sh case_ServerHello;
    HandshakeMessages_signature case_CertificateVerify;
    FStar_Bytes_bytes case_Finished;
    HandshakeMessages_kex_c case_ClientKeyExchange;
    HandshakeMessages_ske case_ServerKeyExchange;
    Prims_list__FStar_Bytes_bytes *case_Certificate;
    HandshakeMessages_cr case_CertificateRequest;
    HandshakeMessages_sticket case_NewSessionTicket;
    Prims_list__Extensions_extension_ *case_EncryptedExtensions;
    HandshakeMessages_crt13 case_Certificate13;
    HandshakeMessages_cr case_CertificateRequest13;
    HandshakeMessages_hrr case_HelloRetryRequest;
    HandshakeMessages_sticket13 case_NewSessionTicket13;
    bool case_KeyUpdate;
    Prims_list__FStar_Bytes_bytes *case_Binders;
    FStar_Bytes_bytes case_MessageHash;
  }
  val;
}
...
typedef struct
FStar_Pervasives_dtuple4__FStar_Bytes_bytes_HandshakeMessages_handshakeType_FStar_Bytes_bytes_FStar_Bytes_bytes_s
{
  FStar_Bytes_bytes _1;
  HandshakeMessages_handshakeType _2;
  FStar_Bytes_bytes _3;
  FStar_Bytes_bytes _4;
}
FStar_Pervasives_dtuple4__FStar_Bytes_bytes_HandshakeMessages_handshakeType_FStar_Bytes_bytes_FStar_Bytes_bytes;

typedef struct
FStar_Pervasives_Native_option__FStar_Pervasives_dtuple4__FStar_Bytes_bytes_HandshakeMessages_handshakeType_FStar_Bytes_bytes_FStar_Bytes_bytes_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  FStar_Pervasives_dtuple4__FStar_Bytes_bytes_HandshakeMessages_handshakeType_FStar_Bytes_bytes_FStar_Bytes_bytes
  v;
}
FStar_Pervasives_Native_option__FStar_Pervasives_dtuple4__FStar_Bytes_bytes_HandshakeMessages_handshakeType_FStar_Bytes_bytes_FStar_Bytes_bytes;

typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_FStar_Pervasives_Native_option__FStar_Pervasives_dtuple4__FStar_Bytes_bytes_HandshakeMessages_handshakeType_FStar_Bytes_bytes_FStar_Bytes_bytes_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
...
typedef struct
K___HandshakeMessages_ch_FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes_s
{
  HandshakeMessages_ch fst;
  FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes snd;
}
K___HandshakeMessages_ch_FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes;

typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___HandshakeMessages_ch_FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
...
typedef struct
K___Prims_list__Parsers_CompressionMethod_compressionMethod_K___FStar_Pervasives_Native_option__Prims_list__Extensions_extension__FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes_s
{
  Prims_list__Parsers_CompressionMethod_compressionMethod *fst;
...
K___Prims_list__Parsers_CompressionMethod_compressionMethod_K___FStar_Pervasives_Native_option__Prims_list__Extensions_extension__FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes;

typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___Prims_list__Parsers_CompressionMethod_compressionMethod_K___FStar_Pervasives_Native_option__Prims_list__Extensions_extension__FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
...
typedef HandshakeMessages_sh HandshakeMessages_valid_sh;

typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_sh_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_sh case_Correct;
  }
  val;
}
...
extern FStar_Bytes_bytes HandshakeMessages_helloRequestBytes;

extern FStar_Bytes_bytes HandshakeMessages_ccsBytes;

extern FStar_Bytes_bytes HandshakeMessages_serverHelloDoneBytes;

typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_crt_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_crt13_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_crt13 case_Correct;
  }
  val;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_cr_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_cr case_Correct;
  }
  val;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_cke_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_kex_c case_Correct;
  }
  val;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_signature_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_signature case_Correct;
  }
  val;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_ske_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_ske case_Correct;
  }
  val;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_fin_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    FStar_Bytes_bytes case_Correct;
  }
  val;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_sticket_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_sticket case_Correct;
  }
  val;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_sticket13_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_sticket13 case_Correct;
  }
  val;
}
...
extern FStar_Bytes_bytes HandshakeMessages_endOfEarlyDataBytes;

typedef struct FStar_Pervasives_Native_option__Parsers_ProtocolVersion_protocolVersion_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  Parsers_ProtocolVersion_protocolVersion v;
}
...
typedef struct Prims_list__HandshakeMessages_hs_msg_s Prims_list__HandshakeMessages_hs_msg;

typedef struct Prims_list__HandshakeMessages_hs_msg_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  HandshakeMessages_hs_msg hd;
  Prims_list__HandshakeMessages_hs_msg *tl;
}
...
typedef struct FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_bool_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_hrr_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_hrr case_Correct;
  }
  val;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_HandshakeMessages_hs_msg_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    HandshakeMessages_hs_msg case_Correct;
  }
  val;
}
...
typedef struct FStar_Pervasives_Native_option__CipherSuite_kexAlg_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  CipherSuite_kexAlg v;
}
...
#define __HandshakeMessages_H_DEFINED
#endif
