...
*Negotiation_ticket13_pskinfo__FStar_Bytes_bytes(
  Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo *acc,
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu___2_4449
)
{
  if (uu___2_4449->tag == Prims_Nil)
    return FStar_List_Tot_Base_rev__FStar_Bytes_bytes___TLSConstants_pskInfo(acc);
  else if (uu___2_4449->tag == Prims_Cons)
  {
    Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *r = uu___2_4449->tl;
    Ticket_ticket t = uu___2_4449->hd.snd;
    FStar_Bytes_bytes tid = uu___2_4449->hd.fst;
...
Negotiation_find_ticket12__FStar_Bytes_bytes(
  ...
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu___0_4288
)
{
  if (uu___0_4288->tag == Prims_Nil)
    return acc;
  else if (uu___0_4288->tag == Prims_Cons)
  {
    Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *r = uu___0_4288->tl;
    Ticket_ticket t = uu___0_4288->hd.snd;
    FStar_Bytes_bytes tid = uu___0_4288->hd.fst;
...
*Negotiation_filter_ticket13__FStar_Bytes_bytes(
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *acc,
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu___1_4367
)
{
  if (uu___1_4367->tag == Prims_Nil)
    return FStar_List_Tot_Base_rev__FStar_Bytes_bytes___Ticket_ticket(acc);
  else if (uu___1_4367->tag == Prims_Cons)
  {
    Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *r = uu___1_4367->tl;
    Ticket_ticket t = uu___1_4367->hd.snd;
    FStar_Bytes_bytes tid = uu___1_4367->hd.fst;
