...
{
  if (uu___0_331->tag == Idx_Preshared)
    return uu___0_331->val.case_Preshared.a;
  else if (uu___0_331->tag == Idx_Derive)
  {
    Idx_pre_id *i1 = uu___0_331->val.case_Derive.i;
    return Idx_ha_of_id(i1);
  }
  else
  {
    KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
