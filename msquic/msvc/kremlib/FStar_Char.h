...
extern FStar_Char_char FStar_Char_lowercase(FStar_Char_char uu____10);

extern FStar_Char_char FStar_Char_uppercase(FStar_Char_char uu____24);

typedef uint32_t FStar_Char_char_code;

extern uint32_t FStar_Char_u32_of_char(FStar_Char_char uu____37);

extern FStar_Char_char FStar_Char_char_of_u32(uint32_t uu____49);
