...
extern uint32_t index_32_be(uint8_t *b, uint32_t i);

KRML_DEPRECATED("LowStar.Endianness.index_32_le")

extern uint32_t index_32_le(uint8_t *b, uint32_t i);

KRML_DEPRECATED("LowStar.Endianness.index_64_be")

extern uint64_t index_64_be(uint8_t *b, uint32_t i);

KRML_DEPRECATED("LowStar.Endianness.index_64_le")

extern uint64_t index_64_le(uint8_t *b, uint32_t i);

KRML_DEPRECATED("LowStar.Endianness.upd_32_be")

extern void upd_32_be(uint8_t *b, uint32_t i, uint32_t v1);
