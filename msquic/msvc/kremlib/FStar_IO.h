...
extern void FStar_IO_print_uint8(uint8_t uu____41);

extern void FStar_IO_print_uint8_dec(uint8_t uu____51);

extern void FStar_IO_print_uint32(uint32_t uu____61);

extern void FStar_IO_print_uint32_dec(uint32_t uu____71);

extern void FStar_IO_print_uint64(uint64_t uu____81);

extern void FStar_IO_print_uint64_dec(uint64_t uu____91);

extern void FStar_IO_print_uint8_hex_pad(uint8_t uu____101);

extern void FStar_IO_print_uint8_dec_pad(uint8_t uu____111);

extern void FStar_IO_print_uint32_hex_pad(uint32_t uu____121);

extern void FStar_IO_print_uint32_dec_pad(uint32_t uu____131);

extern void FStar_IO_print_uint64_hex_pad(uint64_t uu____141);

extern void FStar_IO_print_uint64_dec_pad(uint64_t uu____151);
...
extern FStar_IO_fd_read FStar_IO_open_read_file(Prims_string uu____214);

extern FStar_IO_fd_write FStar_IO_open_write_file(Prims_string uu____226);

extern void FStar_IO_close_read_file(FStar_IO_fd_read uu____237);

extern void FStar_IO_close_write_file(FStar_IO_fd_write uu____247);

extern Prims_string FStar_IO_read_line(FStar_IO_fd_read uu____258);

extern void FStar_IO_write_string(FStar_IO_fd_write uu____277, Prims_string uu____278);
