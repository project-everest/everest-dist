...
#define StAE_Stream 0
#define StAE_StLHAE 1

typedef uint8_t StAE_state_tags;

typedef struct StAE_state_s
{
  StAE_state_tags tag;
  union {
    StreamAE_state case_Stream;
    AEAD_GCM_state case_StLHAE;
  }
  val;
}
StAE_state;
...
typedef struct K___Content_contentType_FStar_Bytes_bytes_s
{
  Content_contentType fst;
  FStar_Bytes_bytes snd;
}
K___Content_contentType_FStar_Bytes_bytes;

FStar_Pervasives_Native_option__Content_fragment
StAE_decrypt(TLSInfo_id i1, StAE_state d, K___Content_contentType_FStar_Bytes_bytes uu____2896);

FStar_Bytes_bytes StreamDeltas_encrypt(TLSInfo_id i1, StAE_state wr, Content_fragment f);

typedef struct Transport_t_s
{
  FStar_Dyn_dyn ptr;
  int32_t (*snd)(FStar_Dyn_dyn x0, uint8_t *x1, uint32_t x2);
...
extern uint32_t Record_headerLen;

extern Prims_int Record_headerLength;

extern FStar_Bytes_bytes Record_fake;
...
typedef struct FStar_Error_optResult__Prims_string____s
{
...
typedef struct K___Content_contentType_Parsers_ProtocolVersion_protocolVersion_Prims_int_s
{
  Content_contentType fst;
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___Content_contentType_Parsers_ProtocolVersion_protocolVersion_Prims_int_s
{
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes_tags
  tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_Error;
    K___Content_contentType_Parsers_ProtocolVersion_protocolVersion_Prims_int case_Correct;
  }
  val;
}
...
#define Record_Header 0
#define Record_Body 1

typedef uint8_t Record_partial_tags;

typedef struct Record_partial_s
{
  Record_partial_tags tag;
  Content_contentType ct;
...
Record___proj__Body__item__pv(Record_partial projectee);

extern uint32_t Record_maxlen;

typedef struct Record_input_state_s
{
  uint32_t *pos;
  uint8_t *b;
}
...
#define Record_ReadError 0
#define Record_ReadWouldBlock 1
#define Record_Received 2

typedef uint8_t Record_read_result_tags;

typedef struct Record_read_result_s
{
  Record_read_result_tags tag;
  union {
    K___Parsers_Alert_alert_Prims_string case_ReadError;
    struct 
    {
      Content_contentType ct;
      Parsers_ProtocolVersion_protocolVersion pv;
...
Record_read_result Record_read(Transport_t tcp0, Record_input_state s0);

#define __Record_H_DEFINED
#endif
