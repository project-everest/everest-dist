...
FStar_List_Tot_Base_fold_left__Prims_string_Parsers_SignatureScheme_signatureScheme(
  Prims_string (*f0)(Prims_string x0, Parsers_SignatureScheme_signatureScheme x1),
  Prims_string x0,
  Prims_list__Parsers_SignatureScheme_signatureScheme *l0
)
{
  Prims_string (*f)(Prims_string x0, Parsers_SignatureScheme_signatureScheme x1) = f0;
  Prims_string x = x0;
  Prims_list__Parsers_SignatureScheme_signatureScheme *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return x;
    else if (l->tag == Prims_Cons)
    {
      ...
      return KRML_EABORT(Prims_string, "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
FStar_List_Tot_Base_fold_left__Prims_string_CipherSuite_cipherSuite_(
  Prims_string (*f0)(Prims_string x0, CipherSuite_cipherSuite_ x1),
  Prims_string x0,
  Prims_list__CipherSuite_cipherSuite_ *l0
)
{
  Prims_string (*f)(Prims_string x0, CipherSuite_cipherSuite_ x1) = f0;
  Prims_string x = x0;
...
FStar_List_Tot_Base_fold_left__Prims_string_Parsers_NamedGroup_namedGroup(
  Prims_string (*f0)(Prims_string x0, Parsers_NamedGroup_namedGroup x1),
  Prims_string x0,
  Prims_list__Parsers_NamedGroup_namedGroup *l0
)
{
  Prims_string (*f)(Prims_string x0, Parsers_NamedGroup_namedGroup x1) = f0;
  Prims_string x = x0;
  Prims_list__Parsers_NamedGroup_namedGroup *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return x;
    else if (l->tag == Prims_Cons)
...
FStar_List_Tot_Base_fold_left__Prims_string_Parsers_CipherSuite_cipherSuite(
  Prims_string (*f0)(Prims_string x0, Parsers_CipherSuite_cipherSuite x1),
  Prims_string x0,
  Prims_list__Parsers_CipherSuite_cipherSuite *l0
)
{
  Prims_string (*f)(Prims_string x0, Parsers_CipherSuite_cipherSuite x1) = f0;
  Prims_string x = x0;
  Prims_list__Parsers_CipherSuite_cipherSuite *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return x;
    else if (l->tag == Prims_Cons)
...
*FStar_List_Tot_Base_rev_acc__FStar_Bytes_bytes___TLSConstants_pskInfo(
  Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo *l0,
  Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo *acc0
)
{
  Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo *l = l0;
  Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo *acc = acc0;
  while (true)
    if (l->tag == Prims_Nil)
      return acc;
    else if (l->tag == Prims_Cons)
...
*Negotiation_ticket13_pskinfo__FStar_Bytes_bytes(
  Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo *acc0,
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu___2_44490
)
{
  Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo *acc = acc0;
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu____0 = uu___2_44490;
  while (true)
    ...
    {
      Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *r = uu____0->tl;
      Ticket_ticket t = uu____0->hd.snd;
      FStar_Bytes_bytes tid = uu____0->hd.fst;
      ...
      if (x0.tag == FStar_Pervasives_Native_Some)
        ...
        ite =
          KRML_EABORT(TLSConstants_pskInfo,
            "unreachable (pattern matches are exhaustive in F*)");
      KRML_CHECK_SIZE(sizeof (Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo),
        (uint32_t)1U);
      Prims_list__K___FStar_Bytes_bytes_TLSConstants_pskInfo
...
*FStar_List_Tot_Base_rev_acc__FStar_Bytes_bytes___Ticket_ticket(
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *l0,
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *acc0
)
{
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *l = l0;
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *acc = acc0;
  while (true)
    if (l->tag == Prims_Nil)
      return acc;
    else if (l->tag == Prims_Cons)
...
*Negotiation_unseal_tickets(
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *acc0,
  Prims_list__K___FStar_Bytes_bytes_FStar_Bytes_bytes *l0
)
{
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *acc = acc0;
  Prims_list__K___FStar_Bytes_bytes_FStar_Bytes_bytes *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
...
Negotiation_find_ticket12__FStar_Bytes_bytes(
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Ticket_ticket acc0,
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu___0_42880
)
{
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Ticket_ticket acc = acc0;
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu____0 = uu___0_42880;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return acc;
    else if (uu____0->tag == Prims_Cons)
    {
      ...
      return
        KRML_EABORT(FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_Ticket_ticket,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
*Negotiation_filter_ticket13__FStar_Bytes_bytes(
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *acc0,
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu___1_43670
)
{
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *acc = acc0;
  Prims_list__K___FStar_Bytes_bytes_Ticket_ticket *uu____0 = uu___1_43670;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return FStar_List_Tot_Base_rev__FStar_Bytes_bytes___Ticket_ticket(acc);
    else if (uu____0->tag == Prims_Cons)
...
FStar_List_Tot_Base_mem__Extensions_extension_(
  Extensions_extension_ x0,
  Prims_list__Extensions_extension_ *uu___7_9530
)
{
  Extensions_extension_ x = x0;
  Prims_list__Extensions_extension_ *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__Extensions_extension_ *tl1 = uu____0->tl;
      Extensions_extension_ hd1 = uu____0->hd;
...
FStar_List_Tot_Base_existsb__Parsers_ProtocolVersion_protocolVersion(
  bool (*f0)(Parsers_ProtocolVersion_protocolVersion x0),
  Prims_list__Parsers_ProtocolVersion_protocolVersion *l0
)
{
  bool (*f)(Parsers_ProtocolVersion_protocolVersion x0) = f0;
...
List_Helpers_find_aux__Parsers_ProtocolVersion_protocolVersion_TLSConstants_config(
  TLSConstants_config env0,
  bool (*f0)(TLSConstants_config x0, Parsers_ProtocolVersion_protocolVersion x1),
  Prims_list__Parsers_ProtocolVersion_protocolVersion *l0
)
{
  TLSConstants_config env = env0;
  bool (*f)(TLSConstants_config x0, Parsers_ProtocolVersion_protocolVersion x1) = f0;
  Prims_list__Parsers_ProtocolVersion_protocolVersion *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return
    ...
    else if (l->tag == Prims_Cons)
    {
      ...
      return
        KRML_EABORT(FStar_Pervasives_Native_option__Parsers_ProtocolVersion_protocolVersion,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
FStar_List_Tot_Base_mem__Parsers_CipherSuite_cipherSuite(
  Parsers_CipherSuite_cipherSuite x0,
  Prims_list__Parsers_CipherSuite_cipherSuite *uu___7_9530
)
{
  Parsers_CipherSuite_cipherSuite x = x0;
  Prims_list__Parsers_CipherSuite_cipherSuite *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__Parsers_CipherSuite_cipherSuite *tl1 = uu____0->tl;
      Parsers_CipherSuite_cipherSuite hd1 = uu____0->hd;
...
Negotiation_is_cs_in_l(
  K___Prims_list__Parsers_CipherSuite_cipherSuite_CipherSuite_sigAlg uu____6783,
  CipherSuite_cipherSuite_ s
)
{
  Prims_list__Parsers_CipherSuite_cipherSuite *l1 = uu____6783.fst;
  CipherSuite_sigAlg sa = uu____6783.snd;
...
List_Helpers_find_aux__CipherSuite_cipherSuite__Prims_list_Parsers_CipherSuite_cipherSuite___CipherSuite_sigAlg(
  K___Prims_list__Parsers_CipherSuite_cipherSuite_CipherSuite_sigAlg env0,
  bool
  (*f0)(
...
{
  K___Prims_list__Parsers_CipherSuite_cipherSuite_CipherSuite_sigAlg env = env0;
  bool
  (*f)(
    K___Prims_list__Parsers_CipherSuite_cipherSuite_CipherSuite_sigAlg x0,
    CipherSuite_cipherSuite_ x1
...
List_Helpers_find_aux__CipherSuite_cipherSuite__CipherSuite_cipherSuite_(
  CipherSuite_cipherSuite_ env0,
  bool (*f0)(CipherSuite_cipherSuite_ x0, CipherSuite_cipherSuite_ x1),
  Prims_list__CipherSuite_cipherSuite_ *l0
)
{
  CipherSuite_cipherSuite_ env = env0;
  bool (*f)(CipherSuite_cipherSuite_ x0, CipherSuite_cipherSuite_ x1) = f0;
  Prims_list__CipherSuite_cipherSuite_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return
...
List_Helpers_find_aux__CommonDH_keyShareEntry_CommonDH_group_(
  CommonDH_group_ env0,
  bool (*f0)(CommonDH_group_ x0, CommonDH_keyShareEntry x1),
  Prims_list__CommonDH_keyShareEntry *l0
)
{
  CommonDH_group_ env = env0;
  bool (*f)(CommonDH_group_ x0, CommonDH_keyShareEntry x1) = f0;
  Prims_list__CommonDH_keyShareEntry *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return
        (
    ...
    else if (l->tag == Prims_Cons)
    {
      ...
      return
        KRML_EABORT(FStar_Pervasives_Native_option__CommonDH_keyShareEntry,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
FStar_List_Tot_Base_mem__Parsers_SignatureScheme_signatureScheme(
  Parsers_SignatureScheme_signatureScheme x0,
  Prims_list__Parsers_SignatureScheme_signatureScheme *uu___7_9530
)
{
  Parsers_SignatureScheme_signatureScheme x = x0;
  Prims_list__Parsers_SignatureScheme_signatureScheme *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__Parsers_SignatureScheme_signatureScheme *tl1 = uu____0->tl;
      Parsers_SignatureScheme_signatureScheme hd1 = uu____0->hd;
...
)
{
  ...
  while (true)
    ...
    {
      l = FStar_List_Tot_Base_tl__FStar_Bytes_bytes___TLSConstants_pskInfo(l);
      i = Prims_op_Subtraction(i, (krml_checked_int_t)1);
    }
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
FStar_List_Tot_Base_mem__CipherSuite_cipherSuite_(
  CipherSuite_cipherSuite_ x0,
  Prims_list__CipherSuite_cipherSuite_ *uu___7_9530
)
{
  CipherSuite_cipherSuite_ x = x0;
  Prims_list__CipherSuite_cipherSuite_ *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__CipherSuite_cipherSuite_ *tl1 = uu____0->tl;
      CipherSuite_cipherSuite_ hd1 = uu____0->hd;
...
FStar_List_Tot_Base_mem__Extensions_psk_kex(
  Extensions_psk_kex x0,
  Prims_list__Extensions_psk_kex *uu___7_9530
)
{
  Extensions_psk_kex x = x0;
  Prims_list__Extensions_psk_kex *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__Extensions_psk_kex *tl1 = uu____0->tl;
      Extensions_psk_kex hd1 = uu____0->hd;
...
FStar_List_Tot_Base_mem__CommonDH_group_(
  CommonDH_group_ x0,
  Prims_list__CommonDH_group_ *uu___7_9530
)
{
  CommonDH_group_ x = x0;
  Prims_list__CommonDH_group_ *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__CommonDH_group_ *tl1 = uu____0->tl;
      CommonDH_group_ hd1 = uu____0->hd;
...
*Negotiation_filter_cipherSuites13_aux(
  ...
  Prims_list__Parsers_CipherSuite_cipherSuite *l0,
  Prims_list__CipherSuite_cipherSuite_ *accu0
)
{
  TLSConstants_config cfg = cfg0;
  Prims_list__Parsers_CipherSuite_cipherSuite *l = l0;
  Prims_list__CipherSuite_cipherSuite_ *accu = accu0;
  while (true)
    if (l->tag == Prims_Nil)
...
List_Helpers_find_aux__Prims_dtuple2_CommonDH_group__CommonDH_pre_share__Prims_list_CommonDH_group_(
  Prims_list__CommonDH_group_ *env0,
  bool
  (*f0)(Prims_list__CommonDH_group_ *x0, Prims_dtuple2__CommonDH_group__CommonDH_pre_share_ x1),
  Prims_list__Prims_dtuple2__CommonDH_group__CommonDH_pre_share_ *l0
)
{
  Prims_list__CommonDH_group_ *env = env0;
  bool
  (*f)(Prims_list__CommonDH_group_ *x0, Prims_dtuple2__CommonDH_group__CommonDH_pre_share_ x1) =
    f0;
  Prims_list__Prims_dtuple2__CommonDH_group__CommonDH_pre_share_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return
        (
...
*FStar_List_Tot_Base_rev_acc__Parsers_SignatureScheme_signatureScheme(
  Prims_list__Parsers_SignatureScheme_signatureScheme *l0,
  Prims_list__Parsers_SignatureScheme_signatureScheme *acc0
)
{
  Prims_list__Parsers_SignatureScheme_signatureScheme *l = l0;
  Prims_list__Parsers_SignatureScheme_signatureScheme *acc = acc0;
  while (true)
    if (l->tag == Prims_Nil)
      return acc;
    else if (l->tag == Prims_Cons)
...
FStar_List_Tot_Base_mem__Parsers_CompressionMethod_compressionMethod(
  Parsers_CompressionMethod_compressionMethod x0,
  Prims_list__Parsers_CompressionMethod_compressionMethod *uu___7_9530
)
{
  Parsers_CompressionMethod_compressionMethod x = x0;
  Prims_list__Parsers_CompressionMethod_compressionMethod *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__Parsers_CompressionMethod_compressionMethod *tl1 = uu____0->tl;
      Parsers_CompressionMethod_compressionMethod hd1 = uu____0->hd;
  ...
  else if (scrut0.tag == FStar_Error_Correct)
  {
    ...
    else
    {
      ...
      else if (scrut1.tag == FStar_Pervasives_Native_Some)
      {
        ...
        CipherSuite_sigAlg sig_10868 = scrut.fst;
        FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___CipherSuite_kexAlg_FStar_Pervasives_Native_option__CipherSuite_sigAlg_CipherSuite_aeAlg_CipherSuite_cipherSuite_
        scrut0 = Negotiation_negotiateCipherSuite(cfg, pv, co.ch_cipher_suites, sig_10868);
        if (scrut0.tag == FStar_Error_Error)
        {
          K___Parsers_Alert_alert_Prims_string z = scrut0.val.case_Error;
          return
...
Negotiation_aux_extension_ok(
  K___HandshakeMessages_ch_HandshakeMessages_hrr uu____10965,
  Extensions_extension_ e
)
{
  HandshakeMessages_ch o1 = uu____10965.fst;
  HandshakeMessages_hrr hrr = uu____10965.snd;
  if (e.tag == Extensions_E_key_share && e.val.case_E_key_share.tag == CommonDH_ClientKeyShare)
  {
...
FStar_List_Tot_Base_fold_left__Prims_string_Parsers_ProtocolVersion_protocolVersion(
  Prims_string (*f0)(Prims_string x0, Parsers_ProtocolVersion_protocolVersion x1),
  Prims_string x0,
  Prims_list__Parsers_ProtocolVersion_protocolVersion *l0
)
{
  Prims_string (*f)(Prims_string x0, Parsers_ProtocolVersion_protocolVersion x1) = f0;
  Prims_string x = x0;
  Prims_list__Parsers_ProtocolVersion_protocolVersion *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
...
List_Helpers_forall_aux__Extensions_extension__HandshakeMessages_ch___HandshakeMessages_hrr(
  K___HandshakeMessages_ch_HandshakeMessages_hrr env0,
  bool (*f0)(K___HandshakeMessages_ch_HandshakeMessages_hrr x0, Extensions_extension_ x1),
  Prims_list__Extensions_extension_ *l0
)
{
  K___HandshakeMessages_ch_HandshakeMessages_hrr env = env0;
  bool (*f)(K___HandshakeMessages_ch_HandshakeMessages_hrr x0, Extensions_extension_ x1) = f0;
  Prims_list__Extensions_extension_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return true;
