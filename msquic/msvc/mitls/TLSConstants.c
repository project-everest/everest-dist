...
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__Prims_string
TLSConstants_parseDistinguishedNameList(
  FStar_Bytes_bytes data0,
  Prims_list__Prims_string *res0
)
{
  FStar_Bytes_bytes data = data0;
  Prims_list__Prims_string *res = res0;
  while (true)
    if (FStar_UInt32_v(FStar_Bytes_len(data)) == (krml_checked_int_t)0)
      return
        (
    ...
    else
    {
      ...
      else if (scrut.tag == FStar_Error_Correct)
      {
        ...
        else if (scrut.tag == FStar_Pervasives_Native_Some)
        {
          ...
          return
            KRML_EABORT(FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__Prims_string,
              "unreachable (pattern matches are exhaustive in F*)");
      }
      else
        return
...
TLSConstants_cert_select_cb(
  ...
  Prims_list__Parsers_SignatureScheme_signatureScheme *sig_6897
)
{
  return
