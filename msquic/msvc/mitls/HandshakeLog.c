...
HandshakeLog_hashHandshakeMessages(
  Prims_list__HandshakeMessages_hs_msg *p10,
  HandshakeLog_hashState hs0,
  Prims_list__HandshakeMessages_hs_msg *n10,
  Prims_list__FStar_Bytes_bytes *nb0
)
{
  Prims_list__HandshakeMessages_hs_msg *p1 = p10;
  HandshakeLog_hashState hs = hs0;
  Prims_list__HandshakeMessages_hs_msg *n1 = n10;
  Prims_list__FStar_Bytes_bytes *nb = nb0;
  while (true)
  {
    ...
    else if (scrut0.fst->tag == Prims_Cons && scrut0.snd->tag == Prims_Cons)
    {
      ...
      if (hs.tag == HandshakeLog_OpenHash)
      {
        ...
        if (m.tag == HandshakeMessages_HelloRetryRequest)
        {
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_DH_anon_WITH_3DES_EDE_CBC_SHA)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_DH_RSA_WITH_AES_128_GCM_SHA256)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_DH_RSA_WITH_AES_256_GCM_SHA384)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_DH_DSS_WITH_AES_128_GCM_SHA256)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (hrr.hrr_cipher_suite.tag == Parsers_CipherSuite_TLS_DH_DSS_WITH_AES_256_GCM_SHA384)
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
                  .tag = FStar_Pervasives_Native_Some,
          ...
          (
            hrr.hrr_cipher_suite.tag
            == Parsers_CipherSuite_TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256
          )
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
          ...
          (
            hrr.hrr_cipher_suite.tag
            == Parsers_CipherSuite_TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256
          )
            scrut0 =
              (
                (FStar_Pervasives_Native_option__CipherSuite_cipherSuite_){
        ...
        *buf0 = KRML_HOST_MALLOC(sizeof (Prims_list__HandshakeMessages_hs_msg));
        buf0[0U]
        = ((Prims_list__HandshakeMessages_hs_msg){ .tag = Prims_Cons, .hd = m, .tl = buf });
        p1 = FStar_List_Tot_Base_append__HandshakeMessages_hs_msg(p1, buf0);
        hs = hs1;
        n1 = mrest;
        nb = brest;
      }
