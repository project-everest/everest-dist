...
extern void (*QUIC_trace)(Prims_string x0);

typedef uint16_t QUIC_error;

void QUIC_quic_check(TLSConstants_config config);

TLSConstants_config QUIC_ffiConfig(FStar_Bytes_bytes host);

typedef struct QUIC_chSummary_s
{
  FStar_Bytes_bytes ch_sni;
  FStar_Bytes_bytes ch_alpn;
  FStar_Bytes_bytes ch_extensions;
  FStar_Pervasives_Native_option__FStar_Bytes_bytes ch_cookie;
  FStar_Pervasives_Native_option__FStar_Bytes_bytes ch_ticket_data;
}
QUIC_chSummary;
...
FStar_Pervasives_Native_option__FStar_Bytes_bytes
QUIC_find_ticket_content(Prims_list__K___FStar_Bytes_bytes_uint32_t *l0);

typedef struct FStar_Pervasives_Native_option__QUIC_chSummary_s
{
...
typedef struct QUIC_hs_out_s
{
  uint32_t consumed;
  FStar_Bytes_bytes output;
  uint32_t to_be_written;
  bool is_complete;
  bool is_writable;
  bool is_early_rejected;
  bool is_post_handshake;
}
QUIC_hs_out;
...
#define QUIC_HS_SUCCESS 0
#define QUIC_HS_ERROR 1

typedef uint8_t QUIC_hs_result_tags;

typedef struct QUIC_hs_result_s
{
  QUIC_hs_result_tags tag;
  union {
    QUIC_hs_out case_HS_SUCCESS;
    uint16_t case_HS_ERROR;
  }
  val;
}
QUIC_hs_result;
...
typedef struct QUIC_raw_key_s
{
  EverCrypt_aead_alg alg;
  FStar_Bytes_bytes aead_key;
  FStar_Bytes_bytes aead_iv;
  FStar_Bytes_bytes pn_key;
}
QUIC_raw_key;
...
QUIC_get_secrets(Old_Handshake_hs_ hs);

typedef struct FStar_Pervasives_Native_option__QUIC_raw_key_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  QUIC_raw_key v;
}
