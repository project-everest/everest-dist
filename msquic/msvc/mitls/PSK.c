...
Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes
**FStar_Monotonic_DependentMap_alloc__Prims_string_FStar_Bytes_bytes_Prims_l_True()
{
  KRML_CHECK_SIZE(sizeof (Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes),
    (uint32_t)1U);
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes
  *buf = KRML_HOST_MALLOC(sizeof (Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes));
  buf[0U] = ((Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes){ .tag = Prims_Nil });
  KRML_CHECK_SIZE(sizeof (Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *),
    (uint32_t)1U);
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes
  **buf0 = KRML_HOST_MALLOC(sizeof (Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *));
  buf0[0U] = buf;
  return buf0;
}

Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes **PSK_tickets;

static FStar_Pervasives_Native_option__FStar_Bytes_bytes
FStar_Monotonic_DependentMap_sel__Prims_string_FStar_Bytes_bytes(
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *r0,
  Prims_string x0
)
{
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *r = r0;
  Prims_string x = x0;
  while (true)
    if (r->tag == Prims_Nil)
      return
        ((FStar_Pervasives_Native_option__FStar_Bytes_bytes){ .tag = FStar_Pervasives_Native_None });
    else if (r->tag == Prims_Cons)
    {
      Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *tl1 = r->tl;
      FStar_Bytes_bytes y = r->hd.snd;
      Prims_string x_ = r->hd.fst;
...
static FStar_Pervasives_Native_option__FStar_Bytes_bytes
FStar_Monotonic_DependentMap_lookup__Prims_string_FStar_Bytes_bytes_Prims_l_True(
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes **t,
  Prims_string x
)
{
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *m = t[0U];
  FStar_Pervasives_Native_option__FStar_Bytes_bytes
  y = FStar_Monotonic_DependentMap_sel__Prims_string_FStar_Bytes_bytes(m, x);
  if (y.tag == FStar_Pervasives_Native_None)
    return y;
  else if (y.tag == FStar_Pervasives_Native_Some)
    return y;
  else
  {
    KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
...
FStar_Pervasives_Native_option__FStar_Bytes_bytes PSK_lookup(Prims_string h1)
{
  return
    FStar_Monotonic_DependentMap_lookup__Prims_string_FStar_Bytes_bytes_Prims_l_True(PSK_tickets,
      h1);
}

static Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes
*FStar_Monotonic_DependentMap_upd__Prims_string_FStar_Bytes_bytes(
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *r,
  Prims_string x,
  FStar_Bytes_bytes v
)
{
...
static void
FStar_Monotonic_DependentMap_extend__Prims_string_FStar_Bytes_bytes_Prims_l_True(
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes **t,
  Prims_string x,
  FStar_Bytes_bytes y
)
{
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *cur = t[0U];
  t[0U] = FStar_Monotonic_DependentMap_upd__Prims_string_FStar_Bytes_bytes(cur, x, y);
}

void PSK_extend(Prims_string h1, FStar_Bytes_bytes t)
{
  FStar_Monotonic_DependentMap_extend__Prims_string_FStar_Bytes_bytes_Prims_l_True(PSK_tickets,
    h1,
    t);
}

Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
...
static FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
FStar_Monotonic_DependentMap_sel__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes(
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
  *r0,
  ...
  *r = r0;
  ...
  while (true)
    if (r->tag == Prims_Nil)
      return
        (
          (FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes){
    ...
    else if (r->tag == Prims_Cons)
    {
      ...
      *tl1 = r->tl;
      ...
      y = r->hd.snd;
      FStar_Bytes_bytes x_ = r->hd.fst;
      if (__eq__FStar_Bytes_bytes(x, x_))
        return
          (
            (FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes){
              .tag = FStar_Pervasives_Native_Some,
      ...
      return
        KRML_EABORT(FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
static FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
FStar_Monotonic_DependentMap_lookup__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes_Prims_l_True(
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
  **t,
  FStar_Bytes_bytes x
)
{
  ...
  *m = t[0U];
  FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
  y =
    FStar_Monotonic_DependentMap_sel__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes(m,
      x);
  if (y.tag == FStar_Pervasives_Native_None)
    return y;
  else if (y.tag == FStar_Pervasives_Native_Some)
...
FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
PSK_s12_lookup(FStar_Bytes_bytes tid)
{
  return
    FStar_Monotonic_DependentMap_lookup__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes_Prims_l_True(PSK_sessions12,
      tid);
}

static Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
*FStar_Monotonic_DependentMap_upd__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes(
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
  *r,
  FStar_Bytes_bytes x,
  K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes v
)
{
  KRML_CHECK_SIZE(sizeof (
      Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
...
static void
FStar_Monotonic_DependentMap_extend__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes_Prims_l_True(
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
  **t,
  FStar_Bytes_bytes x,
  K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes y
)
{
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
  *cur = t[0U];
  t[0U] =
    FStar_Monotonic_DependentMap_upd__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes(cur,
      x,
      y);
}
...
PSK_s12_extend(
  ...
  K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes s
)
{
  FStar_Monotonic_DependentMap_extend__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion___CipherSuite_cipherSuite____bool___FStar_Bytes_bytes_Prims_l_True(PSK_sessions12,
    tid,
    s);
}

Spec_Hash_Definitions_hash_alg PSK_pskInfo_hash(TLSConstants_pskInfo pi)
{
  return pi.early_hash;
}

EverCrypt_aead_alg PSK_pskInfo_ae(TLSConstants_pskInfo pi)
{
  return pi.early_ae;
}

Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
...
typedef struct
FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool v;
}
FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool;

static FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
FStar_Monotonic_DependentMap_sel__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool(
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  *r0,
  FStar_Bytes_bytes x0
)
  ...
  *r = r0;
  ...
  while (true)
    ...
    else if (r->tag == Prims_Cons)
    {
      Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
      *tl1 = r->tl;
      K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool y = r->hd.snd;
      FStar_Bytes_bytes x_ = r->hd.fst;
      if (__eq__FStar_Bytes_bytes(x, x_))
        return
          (
      ...
      return
        KRML_EABORT(FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
static FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
FStar_Monotonic_DependentMap_lookup__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool___(
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  **t,
  FStar_Bytes_bytes x
)
{
  ...
  *m = t[0U];
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  y =
    FStar_Monotonic_DependentMap_sel__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool(m,
      x);
  if (y.tag == FStar_Pervasives_Native_None)
    return y;
  else if (y.tag == FStar_Pervasives_Native_Some)
...
FStar_Bytes_bytes PSK_psk_value(FStar_Bytes_bytes i1)
{
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  scrut =
    FStar_Monotonic_DependentMap_lookup__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool___(PSK_app_psk_table,
      i1);
...
TLSConstants_pskInfo PSK_psk_info(FStar_Bytes_bytes i1)
{
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  scrut =
    FStar_Monotonic_DependentMap_lookup__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool___(PSK_app_psk_table,
...
FStar_Pervasives_Native_option__TLSConstants_pskInfo PSK_psk_lookup(FStar_Bytes_bytes i1)
{
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  scrut =
    FStar_Monotonic_DependentMap_lookup__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool___(PSK_app_psk_table,
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    TLSConstants_pskInfo ctx = scrut.v.snd;
    return
      (
...
FStar_Bytes_bytes PSK_fresh_psk_id()
{
  void *uu____0 = (void *)(uint8_t)0U;
  while (true)
  {
    FStar_Bytes_bytes id1 = Random_sample32((uint32_t)8U);
    FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
    scrut =
      FStar_Monotonic_DependentMap_lookup__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool___(PSK_app_psk_table,
        id1);
...
static Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
*FStar_Monotonic_DependentMap_upd__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool(
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool *r,
  FStar_Bytes_bytes x,
  K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool v
)
{
...
static void
FStar_Monotonic_DependentMap_extend__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool___(
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  **t,
  FStar_Bytes_bytes x,
  K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool y
)
{
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  *cur = t[0U];
  t[0U] =
    FStar_Monotonic_DependentMap_upd__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool(cur,
      x,
      y);
}

void PSK_gen_psk(FStar_Bytes_bytes i1, TLSConstants_pskInfo ctx)
{
  FStar_Bytes_bytes rand1 = Random_sample32((uint32_t)32U);
  FStar_Bytes_bytes psk = FStar_Bytes_append(FStar_Bytes_abyte((uint8_t)1U), rand1);
  K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool add1 = { .fst = psk, .snd = ctx, .thd = true };
  FStar_Monotonic_DependentMap_extend__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool___(PSK_app_psk_table,
    i1,
    add1);
}

void PSK_coerce_psk(FStar_Bytes_bytes i1, TLSConstants_pskInfo ctx, FStar_Bytes_bytes k1)
{
  K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool add1 = { .fst = k1, .snd = ctx, .thd = false };
  FStar_Monotonic_DependentMap_extend__FStar_Bytes_bytes_FStar_Bytes_bytes___TLSConstants_pskInfo___bool___(PSK_app_psk_table,
    i1,
    add1);
}
...
bool
__eq__Spec_Hash_Definitions_hash_alg(
...
bool __eq__EverCrypt_aead_alg(EverCrypt_aead_alg y, EverCrypt_aead_alg x)
{
  switch (x)
  {
...
)
{
  ...
  if (scrut.tag == FStar_Pervasives_Native_Some)
  {
    K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool x = scrut.v;
    TLSConstants_pskInfo ctx = x.snd;
    if
    (
      __eq__Spec_Hash_Definitions_hash_alg(PSK_pskInfo_hash(ctx),
        ha)
      && __eq__EverCrypt_aead_alg(PSK_pskInfo_ae(ctx), ae)
    )
      return true;
    else
      return false;
...
uint32_t PSK_default_obfuscated_age = (uint32_t)0U;

uint32_t PSK_encode_age(uint32_t t, uint32_t mask)
{
  return t + mask;
}

uint32_t PSK_decode_age(uint32_t t, uint32_t mask)
{
  return t - mask;
}
