...
typedef TLSConstants_pskInfo PSK_pskInfo;

typedef Prims_string PSK_hostname;

typedef struct Prims_dtuple2__Prims_string_FStar_Bytes_bytes_s
{
  Prims_string fst;
  FStar_Bytes_bytes snd;
}
Prims_dtuple2__Prims_string_FStar_Bytes_bytes;

typedef struct Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes_s
Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes;

typedef struct Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  Prims_dtuple2__Prims_string_FStar_Bytes_bytes hd;
  Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes *tl;
}
Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes;
...
extern Prims_list__Prims_dtuple2__Prims_string_FStar_Bytes_bytes **PSK_tickets;
...
typedef struct
K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes_s
{
...
typedef struct
Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes_s
{
  FStar_Bytes_bytes fst;
  K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
  snd;
}
Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes;

typedef struct
Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes_s
...
extern Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes
**PSK_sessions12;

typedef struct
FStar_Pervasives_Native_option__K___Parsers_ProtocolVersion_protocolVersion_CipherSuite_cipherSuite__bool_FStar_Bytes_bytes_s
{
...
typedef struct K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool_s
{
  FStar_Bytes_bytes fst;
  TLSConstants_pskInfo snd;
  bool thd;
}
K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool;

typedef struct
Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool_s
{
  FStar_Bytes_bytes fst;
  K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool snd;
}
Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool;

typedef struct
Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool_s
...
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool hd;
  Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
  *tl;
}
Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool;
...
extern Prims_list__Prims_dtuple2__FStar_Bytes_bytes_K___FStar_Bytes_bytes_TLSConstants_pskInfo_bool
**PSK_app_psk_table;

typedef FStar_Bytes_bytes PSK_pskid;

FStar_Bytes_bytes PSK_psk_value(FStar_Bytes_bytes i1);

TLSConstants_pskInfo PSK_psk_info(FStar_Bytes_bytes i1);

typedef struct FStar_Pervasives_Native_option__TLSConstants_pskInfo_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  TLSConstants_pskInfo v;
}
...
typedef uint32_t PSK_ticket_age;

typedef uint32_t PSK_obfuscated_ticket_age;

extern uint32_t PSK_default_obfuscated_age;

uint32_t PSK_encode_age(uint32_t t, uint32_t mask);

uint32_t PSK_decode_age(uint32_t t, uint32_t mask);

#define __PSK_H_DEFINED
#endif
