...
static bool
FStar_List_Tot_Base_isEmpty__Extensions_extension_(Prims_list__Extensions_extension_ *l)
{
  if (l->tag == Prims_Nil)
    return true;
  else
...
*FStar_Pervasives_Native_snd__FStar_Bytes_bytes_Prims_list_Extensions_extension_(
  K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ x
)
{
  return x.snd;
}

bool Cert_is_classic_chain_aux(K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ ces)
{
  return
    FStar_List_Tot_Base_isEmpty__Extensions_extension_(FStar_Pervasives_Native_snd__FStar_Bytes_bytes_Prims_list_Extensions_extension_(ces));
}

static bool
FStar_List_Tot_Base_for_all__FStar_Bytes_bytes___Prims_list_Extensions_extension_(
  bool (*f0)(K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ x0),
  Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *l0
)
{
  bool (*f)(K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ x0) = f0;
  Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return true;
    else if (l->tag == Prims_Cons)
    {
      Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *tl1 = l->tl;
      K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ hd1 = l->hd;
      if (f(hd1))
        l = tl1;
      else
        return false;
...
bool
Cert_is_classic_chain(Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *l)
{
  return
    FStar_List_Tot_Base_for_all__FStar_Bytes_bytes___Prims_list_Extensions_extension_(Cert_is_classic_chain_aux,
      l);
}

K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ Cert_chain_up_aux(FStar_Bytes_bytes c)
{
  ...
  *buf = KRML_HOST_MALLOC(sizeof (Prims_list__Extensions_extension_));
  ...
  return ((K___FStar_Bytes_bytes_Prims_list__Extensions_extension_){ .fst = c, .snd = buf });
}

static Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_
*FStar_List_Tot_Base_map__FStar_Bytes_bytes_FStar_Bytes_bytes___Prims_list_Extensions_extension_(
  K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ (*f)(FStar_Bytes_bytes x0),
    ...
    =
      (
        (Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_){
          .tag = Prims_Cons,
          .hd = f(a),
          .tl = FStar_List_Tot_Base_map__FStar_Bytes_bytes_FStar_Bytes_bytes___Prims_list_Extensions_extension_(f,
            tl1)
        }
      );
    return buf;
...
Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_
*Cert_chain_up(Prims_list__FStar_Bytes_bytes *l)
{
  return
    FStar_List_Tot_Base_map__FStar_Bytes_bytes_FStar_Bytes_bytes___Prims_list_Extensions_extension_(Cert_chain_up_aux,
      l);
}

static Prims_list__FStar_Bytes_bytes
*FStar_List_Tot_Base_map__FStar_Bytes_bytes___Prims_list_Extensions_extension__FStar_Bytes_bytes(
  FStar_Bytes_bytes (*f)(K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ x0),
  Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *x
)
{
  if (x->tag == Prims_Nil)
  {
  ...
  {
    Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *tl1 = x->tl;
    K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ a = x->hd;
    KRML_CHECK_SIZE(sizeof (Prims_list__FStar_Bytes_bytes), (uint32_t)1U);
    Prims_list__FStar_Bytes_bytes *buf = KRML_HOST_MALLOC(sizeof (Prims_list__FStar_Bytes_bytes));
    buf[0U]
    =
      (
        (Prims_list__FStar_Bytes_bytes){
          .tag = Prims_Cons,
          .hd = f(a),
          .tl = FStar_List_Tot_Base_map__FStar_Bytes_bytes___Prims_list_Extensions_extension__FStar_Bytes_bytes(f,
            tl1)
        }
      );
    return buf;
...
FStar_Pervasives_Native_fst__FStar_Bytes_bytes_Prims_list_Extensions_extension_(
  K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ x
)
{
  return x.fst;
...
Prims_list__FStar_Bytes_bytes
*Cert_chain_down(Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *l)
{
  return
    FStar_List_Tot_Base_map__FStar_Bytes_bytes___Prims_list_Extensions_extension__FStar_Bytes_bytes(FStar_Pervasives_Native_fst__FStar_Bytes_bytes_Prims_list_Extensions_extension_,
      l);
}

FStar_Bytes_bytes Cert_certificateListBytes(Prims_list__FStar_Bytes_bytes *uu___0_54)
{
  if (uu___0_54->tag == Prims_Nil)
    return FStar_Bytes_empty_bytes;
  else if (uu___0_54->tag == Prims_Cons)
  {
    Prims_list__FStar_Bytes_bytes *rest = uu___0_54->tl;
    FStar_Bytes_bytes crt = uu___0_54->hd;
    return
      FStar_Bytes_append(Parse_vlbytes((krml_checked_int_t)3, crt),
        Cert_certificateListBytes(rest));
  }
  else
  {
    KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
...
FStar_Bytes_bytes
Cert_certificateListBytes13(
  Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *uu___1_70
)
{
  if (uu___1_70->tag == Prims_Nil)
    return FStar_Bytes_empty_bytes;
  else if (uu___1_70->tag == Prims_Cons)
  {
    Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_ *rest = uu___1_70->tl;
    Prims_list__Extensions_extension_ *exts = uu___1_70->hd.snd;
    FStar_Bytes_bytes crt = uu___1_70->hd.fst;
    return
      FStar_Bytes_append(Parse_vlbytes((krml_checked_int_t)3, crt),
        FStar_Bytes_append(Extensions_extensionsBytes(exts), Cert_certificateListBytes13(rest)));
  }
  else
  {
    KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
...
Cert_parseCertificateList(FStar_Bytes_bytes b)
{
  ...
  else if (Prims_op_LessThan(FStar_UInt32_v(FStar_Bytes_len(b)), (krml_checked_int_t)3))
    return
      TLSError_fatal__Prims_list_FStar_Bytes_bytes(Parsers_AlertDescription_Bad_certificate,
        "not enough bytes (certificate length)");
  else
  {
    FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes
    scrut = Parse_vlsplit((krml_checked_int_t)3, b);
    if (scrut.tag == FStar_Error_Error)
      return
        TLSError_fatal__Prims_list_FStar_Bytes_bytes(Parsers_AlertDescription_Bad_certificate,
          "not enough bytes (certificate)");
    else if (scrut.tag == FStar_Error_Correct)
    {
      K___FStar_Bytes_bytes_FStar_Bytes_bytes x = scrut.val.case_Correct;
      FStar_Bytes_bytes c = x.fst;
      FStar_Bytes_bytes r = x.snd;
      FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__FStar_Bytes_bytes
      scrut = Cert_parseCertificateList(r);
      if (scrut.tag == FStar_Error_Error)
      {
      ...
      {
        Prims_list__FStar_Bytes_bytes *cs = scrut.val.case_Correct;
        KRML_CHECK_SIZE(sizeof (Prims_list__FStar_Bytes_bytes), (uint32_t)1U);
        Prims_list__FStar_Bytes_bytes
        *buf = KRML_HOST_MALLOC(sizeof (Prims_list__FStar_Bytes_bytes));
        buf[0U] = ((Prims_list__FStar_Bytes_bytes){ .tag = Prims_Cons, .hd = c, .tl = cs });
        return
          (
            (FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__FStar_Bytes_bytes){
              .tag = FStar_Error_Correct,
...
TLSError_fatal__Prims_list_FStar_Bytes_bytes___Prims_list_Extensions_extension_(
...
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_
Cert_parseCertificateList13(FStar_Bytes_bytes b)
{
  if (FStar_UInt32_v(FStar_Bytes_len(b)) == (krml_checked_int_t)0)
  {
    KRML_CHECK_SIZE(sizeof (Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_),
    ...
    *buf =
    ...
    return
      TLSError_fatal__Prims_list_FStar_Bytes_bytes___Prims_list_Extensions_extension_(Parsers_AlertDescription_Bad_certificate,
        "not enough bytes (certificate length)");
  else
  {
    FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes
    scrut0 = Parse_vlsplit((krml_checked_int_t)3, b);
    ...
    else if (scrut0.tag == FStar_Error_Correct)
    {
      ...
      FStar_Bytes_bytes c = x.fst;
      FStar_Bytes_bytes r = x.snd;
      if (Prims_op_LessThan(FStar_UInt32_v(FStar_Bytes_len(r)), (krml_checked_int_t)2))
        return
          TLSError_fatal__Prims_list_FStar_Bytes_bytes___Prims_list_Extensions_extension_(Parsers_AlertDescription_Bad_certificate,
            "not enough bytes (extension length");
      else
      {
        FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___FStar_Bytes_bytes_FStar_Bytes_bytes
        scrut0 = Parse_vlsplit((krml_checked_int_t)2, r);
        if (scrut0.tag == FStar_Error_Error)
          return
            TLSError_fatal__Prims_list_FStar_Bytes_bytes___Prims_list_Extensions_extension_(Parsers_AlertDescription_Bad_certificate,
              "not enough bytes (extension list)");
        else if (scrut0.tag == FStar_Error_Correct)
        {
          K___FStar_Bytes_bytes_FStar_Bytes_bytes x1 = scrut0.val.case_Correct;
          FStar_Bytes_bytes e = x1.fst;
          FStar_Bytes_bytes r1 = x1.snd;
          ...
          scrut0 =
            Extensions_parseExtensions(Extensions_EM_Certificate,
              Parse_vlbytes((krml_checked_int_t)2, e));
          if (scrut0.tag == FStar_Error_Error)
          {
          ...
          {
            Prims_list__Extensions_extension_ *exts = scrut0.val.case_Correct.fst;
            FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__K___FStar_Bytes_bytes_Prims_list__Extensions_extension_
            scrut = Cert_parseCertificateList13(r1);
            if (scrut.tag == FStar_Error_Error)
            {
              K___Parsers_Alert_alert_Prims_string z = scrut.val.case_Error;
              return
            ...
            else if (scrut.tag == FStar_Error_Correct)
            {
              ...
              *x2 = scrut.val.case_Correct;
              if (Extensions_bindersLen____(exts) == (krml_checked_int_t)0)
              {
