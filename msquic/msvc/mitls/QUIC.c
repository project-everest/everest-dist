...
{
  return Old_Handshake_rekey_secrets(hs);
}
  ...
  *epochs1 =
  ...
  else
  {
    ...
    if (scrut0.tag == CipherSuite_AEAD)
    {
      ...
      FStar_Pervasives_Native_option__FStar_Bytes_bytes rpn = scrut0.fst;
      FStar_Pervasives_Native_option__FStar_Bytes_bytes wpn = scrut0.snd;
      ...
      if (rw)
      {
        ...
        if (scrut.tag == StAE_Stream)
        {
          ...
          K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes st1 = st.aead;
          FStar_Bytes_bytes x1 = Old_Handshake_random_of(hs);
          K___FStar_Bytes_bytes_FStar_Bytes_bytes
          uu____0 = AEADProvider_leak(TLSInfo_peerId(e.i), TLSConstants_Reader, st1);
          FStar_Bytes_bytes ite;
          if (rpn.tag == FStar_Pervasives_Native_Some)
            ite = rpn.v;
          else
            ite =
      ...
      else
      {
        ...
        if (scrut.tag == StAE_Stream)
        {
          ...
          FStar_Bytes_bytes x1 = Old_Handshake_random_of(hs);
          K___FStar_Bytes_bytes_FStar_Bytes_bytes
          uu____1 = AEADProvider_leak(e.i, TLSConstants_Writer, st1);
          FStar_Bytes_bytes ite;
          if (wpn.tag == FStar_Pervasives_Native_Some)
            ite = wpn.v;
          else
            ite =
              KRML_EABORT(FStar_Bytes_bytes,
