...
void AEADProvider_discard(bool b)
{
  
}

void AEADProvider_print(Prims_string s)
{
  AEADProvider_discard(FStar_IO_debug_print_string(Prims_strcat("AEP| ", Prims_strcat(s, "\n"))));
}

void (*AEADProvider_dbg)(Prims_string x0) = AEADProvider_print;

EverCrypt_aead_alg AEADProvider_alg(TLSInfo_id i1)
{
...
EverCrypt_aead_alg AEADProvider_alg_(TLSInfo_id i1)
{
  CipherSuite_aeAlg scrut = TLSInfo_aeAlg_of_id(i1);
  if (scrut.tag == CipherSuite_AEAD)
    return scrut.val.case_AEAD._0;
...
AEADProvider_evercrypt_aeadAlg_option_of_aead_cipher(EverCrypt_aead_alg uu___0_72)
{
  switch (uu___0_72)
  {
...
EverCrypt_aead_alg AEADProvider_aeadAlg_for_evercrypt(EverCrypt_aead_alg a)
{
  FStar_Pervasives_Native_option__EverCrypt_aead_alg
  x0 = AEADProvider_evercrypt_aeadAlg_option_of_aead_cipher(a);
...
Prims_int AEADProvider_key_length(TLSInfo_id i1)
{
  return FStar_UInt32_v(EverCrypt_aead_keyLen(AEADProvider_alg(i1)));
}

Prims_int AEADProvider_iv_length__TLSInfo_id(TLSInfo_id i1)
{
  return (krml_checked_int_t)12;
}

Prims_int AEADProvider_salt_length(TLSInfo_id i1)
{
  Parsers_ProtocolVersion_protocolVersion scrut = TLSInfo_pv_of_id(i1);
  if (scrut.tag == Parsers_ProtocolVersion_TLS_1p3)
    return AEADProvider_iv_length__TLSInfo_id(i1);
  else
    switch (AEADProvider_alg_(i1))
    {
      case EverCrypt_AES128_GCM:
        {
...
Prims_int AEADProvider_explicit_iv_length(TLSInfo_id i1)
{
  Parsers_ProtocolVersion_protocolVersion scrut = TLSInfo_pv_of_id(i1);
  if (scrut.tag == Parsers_ProtocolVersion_TLS_1p3)
...
FStar_Pervasives_Native_snd__EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes x
)
{
  return x.snd;
}
...
FStar_Bytes_bytes
AEADProvider_salt_of_state(
  TLSInfo_id i1,
  TLSConstants_rw r,
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes s
)
{
  return
    FStar_Pervasives_Native_snd__FStar_Bytes_bytes_FStar_Bytes_bytes(FStar_Pervasives_Native_snd__EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(s));
}

FStar_Bytes_bytes
AEADProvider_key_of_state(
  TLSInfo_id i1,
  TLSConstants_rw r,
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes s
)
{
  return
    FStar_Pervasives_Native_fst__FStar_Bytes_bytes_FStar_Bytes_bytes(FStar_Pervasives_Native_snd__EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(s));
}

typedef struct K___Parsers_ProtocolVersion_protocolVersion_EverCrypt_aead_alg_s
{
  Parsers_ProtocolVersion_protocolVersion fst;
  EverCrypt_aead_alg snd;
}
K___Parsers_ProtocolVersion_protocolVersion_EverCrypt_aead_alg;

Prims_int AEADProvider_noncelen(TLSInfo_id i1)
{
  K___Parsers_ProtocolVersion_protocolVersion_EverCrypt_aead_alg
  scrut = { .fst = TLSInfo_pv_of_id(i1), .snd = AEADProvider_alg(i1) };
  if (scrut.fst.tag == Parsers_ProtocolVersion_TLS_1p3)
    return AEADProvider_iv_length__TLSInfo_id(i1);
  else if (scrut.snd == EverCrypt_CHACHA20_POLY1305)
    return AEADProvider_iv_length__TLSInfo_id(i1);
  else
    return
      Prims_op_Subtraction(AEADProvider_iv_length__TLSInfo_id(i1),
        AEADProvider_salt_length(i1));
}

FStar_Bytes_bytes AEADProvider_coerce_iv(TLSInfo_id i1, FStar_Bytes_bytes b)
{
  return b;
}

FStar_Bytes_bytes
AEADProvider_create_nonce(
  TLSInfo_id i1,
  TLSConstants_rw rw,
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes st,
  FStar_Bytes_bytes n1
)
{
  FStar_Bytes_bytes salt = AEADProvider_salt_of_state(i1, rw, st);
  K___Parsers_ProtocolVersion_protocolVersion_EverCrypt_aead_alg
  scrut = { .fst = TLSInfo_pv_of_id(i1), .snd = AEADProvider_alg(i1) };
  if (scrut.fst.tag == Parsers_ProtocolVersion_TLS_1p3)
    return
      FStar_Bytes_xor(FStar_UInt32_uint_to_t(AEADProvider_iv_length__TLSInfo_id(i1)),
        n1,
        salt);
  else if (scrut.snd == EverCrypt_CHACHA20_POLY1305)
    return
    ...
    return FStar_Bytes_append(salt, n1);
}

K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes
AEADProvider_gen(TLSInfo_id i1)
{
  FStar_Bytes_bytes salt = Random_sample(AEADProvider_salt_length(i1));
  Prims_int klen = FStar_UInt32_v(EverCrypt_aead_keyLen(AEADProvider_alg(i1)));
  FStar_Bytes_bytes kv = Random_sample(klen);
  uint32_t len32 = FStar_UInt32_uint_to_t(klen);
  KRML_CHECK_SIZE(sizeof (uint8_t), len32);
  uint8_t *kvb = alloca(len32 * sizeof (uint8_t));
  memset(kvb, 0U, len32 * sizeof kvb[0U]);
  FStar_Bytes_store_bytes(kv, kvb);
  EverCrypt__aead_state
  *st = EverCrypt_aead_create(AEADProvider_aeadAlg_for_evercrypt(AEADProvider_alg(i1)), kvb);
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes
  res = { .fst = st, .snd = { .fst = kv, .snd = salt } };
  return res;
}
...
{
  return
    FStar_Pervasives_Native_snd__EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(st);
}

K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes
AEADProvider_genReader(
  TLSInfo_id i1,
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes st
)
{
  EverCrypt__aead_state *s = st.fst;
  K___FStar_Bytes_bytes_FStar_Bytes_bytes k1 = st.snd;
  return
    ((K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes){ .fst = s, .snd = k1 });
}

K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes
AEADProvider_coerce(TLSInfo_id i1, FStar_Bytes_bytes k1, FStar_Bytes_bytes s)
{
  AEADProvider_print(Prims_strcat("COERCE(K=",
      Prims_strcat(FStar_Bytes_hex_of_bytes(k1),
        Prims_strcat(", SIV=", Prims_strcat(FStar_Bytes_hex_of_bytes(s), ")")))));
  Prims_int len1 = FStar_UInt32_v(FStar_Bytes_len(k1));
  uint32_t len32 = FStar_UInt32_uint_to_t(len1);
  KRML_CHECK_SIZE(sizeof (uint8_t), len32);
  uint8_t *kvb = alloca(len32 * sizeof (uint8_t));
  memset(kvb, 0U, len32 * sizeof kvb[0U]);
  FStar_Bytes_store_bytes(k1, kvb);
  EverCrypt__aead_state
  *st = EverCrypt_aead_create(AEADProvider_aeadAlg_for_evercrypt(AEADProvider_alg(i1)), kvb);
  return
    (
...
FStar_Bytes_bytes AEADProvider_repr(TLSInfo_id i1, Prims_int l, FStar_Bytes_bytes p1)
{
  return p1;
}

Prims_int AEADProvider_adlen(TLSInfo_id i1)
{
  Parsers_ProtocolVersion_protocolVersion scrut = TLSInfo_pv_of_id(i1);
  if (scrut.tag == Parsers_ProtocolVersion_TLS_1p3)
    return (krml_checked_int_t)0;
  else
    return (krml_checked_int_t)13;
}

Prims_int AEADProvider_taglen(TLSInfo_id i1)
{
  return FStar_UInt32_v(EverCrypt_aead_tagLen(AEADProvider_alg(i1)));
}

Prims_int AEADProvider_cipherlen(TLSInfo_id i1, Prims_int l)
{
  return Prims_op_Addition(l, AEADProvider_taglen(i1));
}

static EverCrypt__aead_state
*FStar_Pervasives_Native_fst__EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes x
)
{
  return x.fst;
...
FStar_Bytes_bytes
AEADProvider_encrypt(
  TLSInfo_id i1,
  Prims_int l,
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes w,
  FStar_Bytes_bytes iv,
  FStar_Bytes_bytes ad,
  FStar_Bytes_bytes plain
)
{
  AEADProvider_print(Prims_strcat("ENCRYPT[N=",
      Prims_strcat(FStar_Bytes_hex_of_bytes(iv),
        Prims_strcat(",AD=", Prims_strcat(FStar_Bytes_hex_of_bytes(ad), "]")))));
  uint32_t adlen1 = FStar_UInt32_uint_to_t(FStar_UInt32_v(FStar_Bytes_len(ad)));
  uint32_t plainlen = FStar_UInt32_uint_to_t(l);
  uint32_t taglen1 = FStar_UInt32_uint_to_t(AEADProvider_taglen(i1));
  uint32_t cipherlen1 = plainlen + taglen1;
  uint32_t len10 = FStar_UInt32_uint_to_t(FStar_UInt32_v(FStar_Bytes_len(ad)));
  KRML_CHECK_SIZE(sizeof (uint8_t), len10);
  uint8_t *lb = alloca(len10 * sizeof (uint8_t));
  memset(lb, 0U, len10 * sizeof lb[0U]);
  FStar_Bytes_store_bytes(ad, lb);
  uint8_t *ad1 = lb;
  KRML_CHECK_SIZE(sizeof (uint8_t), cipherlen1);
  uint8_t *cipher_tag = alloca(cipherlen1 * sizeof (uint8_t));
  memset(cipher_tag, 0U, cipherlen1 * sizeof cipher_tag[0U]);
  uint8_t *cipher = cipher_tag;
  uint8_t *tag = cipher_tag + plainlen;
  uint32_t len11 = FStar_UInt32_uint_to_t(FStar_UInt32_v(FStar_Bytes_len(iv)));
  KRML_CHECK_SIZE(sizeof (uint8_t), len11);
  uint8_t *lb0 = alloca(len11 * sizeof (uint8_t));
  memset(lb0, 0U, len11 * sizeof lb0[0U]);
  FStar_Bytes_store_bytes(iv, lb0);
  uint8_t *iv1 = lb0;
  uint32_t len1 = FStar_UInt32_uint_to_t(FStar_UInt32_v(FStar_Bytes_len(plain)));
  KRML_CHECK_SIZE(sizeof (uint8_t), len1);
  uint8_t *lb1 = alloca(len1 * sizeof (uint8_t));
  memset(lb1, 0U, len1 * sizeof lb1[0U]);
  FStar_Bytes_store_bytes(plain, lb1);
  uint8_t *plain1 = lb1;
  EverCrypt_aead_encrypt(FStar_Pervasives_Native_fst__EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(w),
    iv1,
    ad1,
    adlen1,
    plain1,
    ...
    cipher,
    tag);
  FStar_Bytes_bytes cipher_tag_res = FStar_Bytes_of_buffer(cipherlen1, cipher_tag);
  return cipher_tag_res;
}

FStar_Pervasives_Native_option__FStar_Bytes_bytes
AEADProvider_decrypt(
  TLSInfo_id i1,
  Prims_int l,
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes st,
  FStar_Bytes_bytes iv,
...
{
  AEADProvider_print(Prims_strcat("DECRYPT[N=",
      Prims_strcat(FStar_Bytes_hex_of_bytes(iv),
        Prims_strcat(",AD=", Prims_strcat(FStar_Bytes_hex_of_bytes(ad), "]")))));
  uint32_t len10 = FStar_UInt32_uint_to_t(FStar_UInt32_v(FStar_Bytes_len(iv)));
  KRML_CHECK_SIZE(sizeof (uint8_t), len10);
  uint8_t *lb = alloca(len10 * sizeof (uint8_t));
  memset(lb, 0U, len10 * sizeof lb[0U]);
  FStar_Bytes_store_bytes(iv, lb);
  uint8_t *iv1 = lb;
  uint32_t adlen1 = FStar_UInt32_uint_to_t(FStar_UInt32_v(FStar_Bytes_len(ad)));
  uint32_t len1 = FStar_UInt32_uint_to_t(FStar_UInt32_v(FStar_Bytes_len(ad)));
  KRML_CHECK_SIZE(sizeof (uint8_t), len1);
  uint8_t *lb0 = alloca(len1 * sizeof (uint8_t));
  memset(lb0, 0U, len1 * sizeof lb0[0U]);
  FStar_Bytes_store_bytes(ad, lb0);
  uint8_t *ad1 = lb0;
  uint32_t plainlen = FStar_UInt32_uint_to_t(l);
  uint32_t taglen1 = FStar_UInt32_uint_to_t(AEADProvider_taglen(i1));
  uint32_t len11 = FStar_UInt32_uint_to_t(FStar_UInt32_v(FStar_Bytes_len(cipher)));
  KRML_CHECK_SIZE(sizeof (uint8_t), len11);
  uint8_t *lb1 = alloca(len11 * sizeof (uint8_t));
  memset(lb1, 0U, len11 * sizeof lb1[0U]);
  FStar_Bytes_store_bytes(cipher, lb1);
  uint8_t *cipher_tag_buf = lb1;
  uint8_t *cipher1 = cipher_tag_buf;
  uint8_t *tag = cipher_tag_buf + plainlen;
  KRML_CHECK_SIZE(sizeof (uint8_t), plainlen);
  uint8_t *plain = alloca(plainlen * sizeof (uint8_t));
  memset(plain, 0U, plainlen * sizeof plain[0U]);
  uint32_t
  ok =
    EverCrypt_aead_decrypt(FStar_Pervasives_Native_fst__EverCrypt__aead_state__FStar_Bytes_bytes___FStar_Bytes_bytes(st),
      iv1,
      ad1,
      adlen1,
      plain,
  ...
  if (ok == (uint32_t)1U)
    ret =
      (
        (FStar_Pervasives_Native_option__FStar_Bytes_bytes){
          .tag = FStar_Pervasives_Native_Some,
          .v = FStar_Bytes_of_buffer(plainlen, plain)
        }
      );
  else
    ret =
