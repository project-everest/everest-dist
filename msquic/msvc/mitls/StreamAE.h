...
typedef struct FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Content_fragment_s
{
...
typedef struct FStar_Pervasives_Native_option__Content_fragment_s
{
...
typedef void *StreamAE_rid;

typedef TLSInfo_id StreamAE_id;
...
typedef struct StreamAE_entry_s
{
  Prims_int l;
  FStar_Bytes_bytes c;
  Content_fragment p;
...
extern Prims_int StreamAE_max_ctr;

typedef Prims_int StreamAE_counter;

Prims_int *StreamAE_ctr(TLSInfo_id i1, Prims_int *c);

typedef struct StreamAE_state_s
{
  K___EverCrypt__aead_state__K___FStar_Bytes_bytes_FStar_Bytes_bytes aead;
  Prims_int *counter;
}
StreamAE_state;
...
StreamAE_strip_refinement__Content_fragment___(
  FStar_Pervasives_Native_option__Content_fragment uu___0_2533
);
