...
StreamPlain_scan(TLSInfo_id i10, FStar_Bytes_bytes bs0, Prims_int j10)
{
  TLSInfo_id i1 = i10;
  FStar_Bytes_bytes bs = bs0;
  Prims_int j1 = j10;
  while (true)
  {
    Prims_int len1;
      ...
      case 0U:
        {
          if (Prims_op_GreaterThan(j1, (krml_checked_int_t)0))
            j1 = Prims_op_Subtraction(j1, (krml_checked_int_t)1);
          else
            return
      ...
      case 21U:
        {
          ...
          else if (j1 == (krml_checked_int_t)2)
          {
            ...
            else if (scrut.tag == FStar_Error_Error)
            {
              ...
              return
                KRML_EABORT(FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Content_fragment,
...
{
  if (uu___0_2533.tag == FStar_Pervasives_Native_None)
    return
      ((FStar_Pervasives_Native_option__Content_fragment){ .tag = FStar_Pervasives_Native_None });
  else if (uu___0_2533.tag == FStar_Pervasives_Native_Some)
  {
    Content_fragment x = uu___0_2533.v;
    return
      (
        (FStar_Pervasives_Native_option__Content_fragment){
          .tag = FStar_Pervasives_Native_Some,
