...
extern FStar_Bytes_bytes TLSPRF_tls_client_label;

extern FStar_Bytes_bytes TLSPRF_tls_server_label;
...
extern bool PMS_ideal;

typedef FStar_Bytes_bytes PMS_rsarepr;

typedef FStar_Bytes_bytes PMS_rsaseed;

FStar_Bytes_bytes PMS___proj__Mkrsaseed__item__seed(FStar_Bytes_bytes projectee);

#define PMS_IdealRSAPMS 0
#define PMS_ConcreteRSAPMS 1

typedef uint8_t PMS_rsapms_tags;

typedef struct PMS_rsapms_s
{
  PMS_rsapms_tags tag;
  union {
    FStar_Bytes_bytes case_IdealRSAPMS;
    FStar_Bytes_bytes case_ConcreteRSAPMS;
  }
  val;
}
PMS_rsapms;
...
typedef FStar_Bytes_bytes PMS_dhrepr;

typedef FStar_Bytes_bytes PMS_dhseed;

FStar_Bytes_bytes PMS___proj__Mkdhseed__item__seed(FStar_Bytes_bytes projectee);

#define PMS_IdealDHPMS 0
#define PMS_ConcreteDHPMS 1

typedef uint8_t PMS_dhpms_tags;

typedef struct PMS_dhpms_s
{
  PMS_dhpms_tags tag;
  union {
    FStar_Bytes_bytes case_IdealDHPMS;
    FStar_Bytes_bytes case_ConcreteDHPMS;
  }
  val;
}
PMS_dhpms;
...
typedef struct K___FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion_PMS_rsapms_s
{
...
#define PMS_RSAPMS 0
#define PMS_DHPMS 1
#define PMS_DummyPMS 2

typedef uint8_t PMS_pms_tags;

typedef struct PMS_pms_s
{
  PMS_pms_tags tag;
  union {
    K___FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion_PMS_rsapms case_RSAPMS;
    struct 
    {
      CommonDH_group_ g;
      CommonDH_pre_share_ gx;
      CommonDH_pre_share_ _2;
      PMS_dhpms _3;
    }
    case_DHPMS;
  }
