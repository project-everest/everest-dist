...
static Content_fragment
FStar_List_Tot_Base_index__Content_fragment(Prims_list__Content_fragment *l0, Prims_int i0)
{
  Prims_list__Content_fragment *l = l0;
  Prims_int i = i0;
  while (true)
    ...
    {
      l = FStar_List_Tot_Base_tl__Content_fragment(l);
