...
#define DataStream_Data 0
#define DataStream_Close 1
#define DataStream_Alert 2

typedef uint8_t DataStream_delta_tags;

typedef struct DataStream_delta_s
{
  DataStream_delta_tags tag;
  union {
    FStar_Bytes_bytes case_Data;
    Parsers_Alert_alert case_Alert;
  }
  val;
}
DataStream_delta;
...
#define Content_CT_Alert 0
#define Content_CT_Handshake 1
#define Content_CT_CCS 2
#define Content_CT_Data 3

typedef uint8_t Content_fragment_tags;

typedef struct Content_fragment_s
{
  Content_fragment_tags tag;
  union {
    struct 
    {
      K___Prims_int_Prims_int rg;
      Parsers_Alert_alert _1;
    }
    case_CT_Alert;
    struct 
    {
    ...
    case_CT_Handshake;
    K___Prims_int_Prims_int case_CT_CCS;
    struct 
    {
      K___Prims_int_Prims_int rg;
      FStar_Bytes_bytes f;
...
typedef struct Prims_list__Content_fragment_s Prims_list__Content_fragment;

typedef struct Prims_list__Content_fragment_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  Content_fragment hd;
  Prims_list__Content_fragment *tl;
}
Prims_list__Content_fragment;

typedef struct Prims_list__DataStream_delta_s Prims_list__DataStream_delta;

typedef struct Prims_list__DataStream_delta_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  DataStream_delta hd;
  Prims_list__DataStream_delta *tl;
}
Prims_list__DataStream_delta;

Prims_list__DataStream_delta *Content_project(TLSInfo_id i1, Prims_list__Content_fragment *fs);

#define Content_Change_cipher_spec 0
#define Content_Alert 1
#define Content_Handshake 2
#define Content_Application_data 3

typedef uint8_t Content_contentType;
...
typedef Content_contentType Content_contentType13;

FStar_Bytes_bytes Content_ctBytes(Content_contentType uu___0_975);

typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Content_contentType_s
{
  ...
  union {
    ...
    Content_contentType case_Correct;
  }
  val;
}
...
typedef struct K___Content_contentType_K___Prims_int_Prims_int_s
{
...
extern FStar_Bytes_bytes Content_ccsBytes;
