...
typedef Prims_string FFI_cbytes;

void FFI_discard(bool uu____12);

void FFI_print(Prims_string s);

extern void (*FFI_trace)(Prims_string x0);

typedef struct K___Connection_connection_Prims_int_s
{
  Connection_connection fst;
  Prims_int snd;
}
...
#define FFI_Received 0
#define FFI_WouldBlock 1
#define FFI_Errno 2

typedef uint8_t FFI_read_result_tags;

typedef struct FFI_read_result_s
{
  FFI_read_result_tags tag;
  union {
    FStar_Bytes_bytes case_Received;
    Prims_int case_Errno;
  }
  val;
}
FFI_read_result;
...
FFI_read_result FFI_read(Connection_connection c0);
...
typedef struct K___Prims_string_Parsers_CipherSuite_cipherSuite_s
{
  Prims_string fst;
  Parsers_CipherSuite_cipherSuite snd;
}
K___Prims_string_Parsers_CipherSuite_cipherSuite;

typedef struct Prims_list__K___Prims_string_Parsers_CipherSuite_cipherSuite_s
Prims_list__K___Prims_string_Parsers_CipherSuite_cipherSuite;

typedef struct Prims_list__K___Prims_string_Parsers_CipherSuite_cipherSuite_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  K___Prims_string_Parsers_CipherSuite_cipherSuite hd;
  Prims_list__K___Prims_string_Parsers_CipherSuite_cipherSuite *tl;
}
Prims_list__K___Prims_string_Parsers_CipherSuite_cipherSuite;

extern Prims_list__K___Prims_string_Parsers_CipherSuite_cipherSuite *FFI_css;

typedef struct K___Prims_string_Parsers_SignatureScheme_signatureScheme_s
{
  Prims_string fst;
  Parsers_SignatureScheme_signatureScheme snd;
}
K___Prims_string_Parsers_SignatureScheme_signatureScheme;

typedef struct Prims_list__K___Prims_string_Parsers_SignatureScheme_signatureScheme_s
Prims_list__K___Prims_string_Parsers_SignatureScheme_signatureScheme;

typedef struct Prims_list__K___Prims_string_Parsers_SignatureScheme_signatureScheme_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  K___Prims_string_Parsers_SignatureScheme_signatureScheme hd;
  Prims_list__K___Prims_string_Parsers_SignatureScheme_signatureScheme *tl;
}
Prims_list__K___Prims_string_Parsers_SignatureScheme_signatureScheme;

extern Prims_list__K___Prims_string_Parsers_SignatureScheme_signatureScheme *FFI_sas;

typedef struct K___Prims_string_Parsers_NamedGroup_namedGroup_s
{
  Prims_string fst;
  Parsers_NamedGroup_namedGroup snd;
}
K___Prims_string_Parsers_NamedGroup_namedGroup;

typedef struct Prims_list__K___Prims_string_Parsers_NamedGroup_namedGroup_s
Prims_list__K___Prims_string_Parsers_NamedGroup_namedGroup;

typedef struct Prims_list__K___Prims_string_Parsers_NamedGroup_namedGroup_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  K___Prims_string_Parsers_NamedGroup_namedGroup hd;
  Prims_list__K___Prims_string_Parsers_NamedGroup_namedGroup *tl;
}
Prims_list__K___Prims_string_Parsers_NamedGroup_namedGroup;

extern Prims_list__K___Prims_string_Parsers_NamedGroup_namedGroup *FFI_ngs;

typedef struct K___Prims_string_EverCrypt_aead_alg_s
{
  Prims_string fst;
  EverCrypt_aead_alg snd;
}
K___Prims_string_EverCrypt_aead_alg;

typedef struct Prims_list__K___Prims_string_EverCrypt_aead_alg_s
Prims_list__K___Prims_string_EverCrypt_aead_alg;

typedef struct Prims_list__K___Prims_string_EverCrypt_aead_alg_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  K___Prims_string_EverCrypt_aead_alg hd;
  Prims_list__K___Prims_string_EverCrypt_aead_alg *tl;
}
Prims_list__K___Prims_string_EverCrypt_aead_alg;

extern Prims_list__K___Prims_string_EverCrypt_aead_alg *FFI_aeads;

TLSConstants_config FFI_ffiConfig(Prims_string version1, FStar_Bytes_bytes host);

TLSConstants_config FFI_updatecfg(TLSConstants_config cfg0, Prims_list__Prims_string *l0);

typedef struct FStar_Pervasives_Native_option__Parsers_CipherSuite_cipherSuite_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  Parsers_CipherSuite_cipherSuite v;
}
...
FFI_findsetting__Prims_string_Parsers_CipherSuite_cipherSuite(
  Prims_string f0,
  Prims_list__K___Prims_string_Parsers_CipherSuite_cipherSuite *l0
);
...
FFI_findsetting__Prims_string_Parsers_SignatureScheme_signatureScheme(
  Prims_string f0,
  Prims_list__K___Prims_string_Parsers_SignatureScheme_signatureScheme *l0
);
...
FFI_findsetting__Prims_string_Parsers_NamedGroup_namedGroup(
  Prims_string f0,
  Prims_list__K___Prims_string_Parsers_NamedGroup_namedGroup *l0
);
...
FFI_findsetting__Prims_string_EverCrypt_aead_alg(
  Prims_string f0,
  Prims_list__K___Prims_string_EverCrypt_aead_alg *l0
);
...
typedef struct K___Spec_Hash_Definitions_hash_alg_EverCrypt_aead_alg_FStar_Bytes_bytes_s
{
  Spec_Hash_Definitions_hash_alg fst;
  EverCrypt_aead_alg snd;
  FStar_Bytes_bytes thd;
}
K___Spec_Hash_Definitions_hash_alg_EverCrypt_aead_alg_FStar_Bytes_bytes;

typedef struct
FStar_Pervasives_Native_option__K___Spec_Hash_Definitions_hash_alg_EverCrypt_aead_alg_FStar_Bytes_bytes_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  K___Spec_Hash_Definitions_hash_alg_EverCrypt_aead_alg_FStar_Bytes_bytes v;
}
