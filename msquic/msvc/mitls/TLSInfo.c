...
EverCrypt_aead_alg TLSInfo_logInfo_ae(TLSInfo_logInfo uu___1_2431)
{
  if (uu___1_2431.tag == TLSInfo_LogInfo_CH0)
  {
    TLSInfo_logInfo_CH0 x = uu___1_2431.val.case_LogInfo_CH0;
    return x.li_ch0_ed_ae;
  }
  else if (uu___1_2431.tag == TLSInfo_LogInfo_SH)
  {
    TLSInfo_logInfo_SH x = uu___1_2431.val.case_LogInfo_SH;
    return x.li_sh_ae;
  }
  else if (uu___1_2431.tag == TLSInfo_LogInfo_SF)
  {
    TLSInfo_logInfo_SF x = uu___1_2431.val.case_LogInfo_SF;
    return x.li_sf_sh.li_sh_ae;
  }
  else if (uu___1_2431.tag == TLSInfo_LogInfo_CF)
  {
    TLSInfo_logInfo_CF x = uu___1_2431.val.case_LogInfo_CF;
...
Spec_Hash_Definitions_hash_alg TLSInfo_logInfo_hash(TLSInfo_logInfo uu___2_2446)
{
  if (uu___2_2446.tag == TLSInfo_LogInfo_CH0)
  {
    TLSInfo_logInfo_CH0 x = uu___2_2446.val.case_LogInfo_CH0;
    return x.li_ch0_ed_hash;
  }
  else if (uu___2_2446.tag == TLSInfo_LogInfo_SH)
  {
    TLSInfo_logInfo_SH x = uu___2_2446.val.case_LogInfo_SH;
    return x.li_sh_hash;
  }
  else if (uu___2_2446.tag == TLSInfo_LogInfo_SF)
  {
    TLSInfo_logInfo_SF x = uu___2_2446.val.case_LogInfo_SF;
    return x.li_sf_sh.li_sh_hash;
  }
  else if (uu___2_2446.tag == TLSInfo_LogInfo_CF)
  {
    TLSInfo_logInfo_CF x = uu___2_2446.val.case_LogInfo_CF;
...
FStar_Bytes_bytes TLSInfo_logInfo_nonce(TLSInfo_logInfo uu___3_2462)
{
  if (uu___3_2462.tag == TLSInfo_LogInfo_CH)
  {
    TLSInfo_logInfo_CH x = uu___3_2462.val.case_LogInfo_CH;
    return x.li_ch_cr;
  }
  else if (uu___3_2462.tag == TLSInfo_LogInfo_CH0)
  {
    TLSInfo_logInfo_CH0 x = uu___3_2462.val.case_LogInfo_CH0;
    return x.li_ch0_cr;
  }
  else if (uu___3_2462.tag == TLSInfo_LogInfo_SH)
  {
    TLSInfo_logInfo_SH x = uu___3_2462.val.case_LogInfo_SH;
    return x.li_sh_cr;
  }
  else if (uu___3_2462.tag == TLSInfo_LogInfo_SF)
  {
    TLSInfo_logInfo_SF x = uu___3_2462.val.case_LogInfo_SF;
    return x.li_sf_sh.li_sh_cr;
  }
  else if (uu___3_2462.tag == TLSInfo_LogInfo_CF)
  {
    TLSInfo_logInfo_CF x = uu___3_2462.val.case_LogInfo_CF;
...
Spec_Hash_Definitions_hash_alg TLSInfo_esId_hash(TLSInfo_pre_esId *uu___4_4144)
{
  if (uu___4_4144->tag == TLSInfo_ApplicationPSK)
    return uu___4_4144->val.case_ApplicationPSK.ha;
  else if (uu___4_4144->tag == TLSInfo_ResumptionPSK)
  {
    TLSInfo_pre_rmsId *i1 = uu___4_4144->val.case_ResumptionPSK.i;
    TLSInfo_logInfo li = uu___4_4144->val.case_ResumptionPSK.li;
    return TLSInfo_rmsId_hash(li, i1);
  }
  else if (uu___4_4144->tag == TLSInfo_NoPSK)
    return uu___4_4144->val.case_NoPSK;
  else
  {
    KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
      __FILE__,
...
Spec_Hash_Definitions_hash_alg TLSInfo_binderId_hash(TLSInfo_pre_binderId *uu___5_4153)
{
  TLSInfo_pre_esId *i1 = uu___5_4153->_0;
  return TLSInfo_esId_hash(i1);
}

Spec_Hash_Definitions_hash_alg TLSInfo_hsId_hash(TLSInfo_pre_hsId *uu___6_4156)
{
  if (uu___6_4156->tag == TLSInfo_HSID_PSK)
  {
    TLSInfo_pre_saltId *i1 = uu___6_4156->val.case_HSID_PSK;
    return TLSInfo_saltId_hash(i1);
  }
  else if (uu___6_4156->tag == TLSInfo_HSID_DHE)
  {
    TLSInfo_pre_saltId *i1 = uu___6_4156->val.case_HSID_DHE._0;
    return TLSInfo_saltId_hash(i1);
  }
  else
  {
...
Spec_Hash_Definitions_hash_alg TLSInfo_asId_hash(TLSInfo_pre_asId *uu___7_4171)
{
  TLSInfo_pre_saltId *i1 = uu___7_4171->_0;
  return TLSInfo_saltId_hash(i1);
}

Spec_Hash_Definitions_hash_alg TLSInfo_saltId_hash(TLSInfo_pre_saltId *uu___8_4173)
{
  TLSInfo_pre_secretId *i1 = uu___8_4173->_0;
  return TLSInfo_secretId_hash(i1);
}

Spec_Hash_Definitions_hash_alg TLSInfo_secretId_hash(TLSInfo_pre_secretId *uu___9_4175)
{
  if (uu___9_4175->tag == TLSInfo_EarlySecretID)
  {
    TLSInfo_pre_esId *i1 = uu___9_4175->val.case_EarlySecretID;
    return TLSInfo_esId_hash(i1);
  }
  else if (uu___9_4175->tag == TLSInfo_HandshakeSecretID)
  {
    TLSInfo_pre_hsId *i1 = uu___9_4175->val.case_HandshakeSecretID;
    return TLSInfo_hsId_hash(i1);
  }
  else if (uu___9_4175->tag == TLSInfo_ApplicationSecretID)
  {
    TLSInfo_pre_asId *i1 = uu___9_4175->val.case_ApplicationSecretID;
...
Spec_Hash_Definitions_hash_alg TLSInfo_keyId_hash(TLSInfo_pre_keyId *uu___10_4208)
{
  TLSInfo_pre_expandId *i1 = uu___10_4208->i;
  TLSInfo_logInfo li = uu___10_4208->li;
  return TLSInfo_expandId_hash(li, i1);
}

Spec_Hash_Definitions_hash_alg TLSInfo_finishedId_hash(TLSInfo_pre_finishedId *uu___11_4213)
{
  TLSInfo_pre_expandId *i1 = uu___11_4213->_1;
  TLSInfo_logInfo li = uu___11_4213->li;
  return TLSInfo_expandId_hash(li, i1);
}
...
TLSInfo_expandTag *TLSInfo_peerLabel(TLSInfo_expandTag *uu___12_5184)
{
  if (uu___12_5184[0U] == TLSInfo_ClientEarlyTrafficSecret)
  {
  ...
  else if (uu___12_5184[0U] == TLSInfo_ApplicationTrafficSecret)
  {
    KRML_CHECK_SIZE(sizeof (TLSInfo_expandTag), (uint32_t)1U);
    TLSInfo_expandTag *buf = KRML_HOST_MALLOC(sizeof (TLSInfo_expandTag));
  ...
  else if (uu___12_5184[0U] == TLSInfo_ClientHandshakeTrafficSecret)
  {
    KRML_CHECK_SIZE(sizeof (TLSInfo_expandTag), (uint32_t)1U);
    TLSInfo_expandTag *buf = KRML_HOST_MALLOC(sizeof (TLSInfo_expandTag));
  ...
  else if (uu___12_5184[0U] == TLSInfo_ServerHandshakeTrafficSecret)
  {
    KRML_CHECK_SIZE(sizeof (TLSInfo_expandTag), (uint32_t)1U);
    TLSInfo_expandTag *buf = KRML_HOST_MALLOC(sizeof (TLSInfo_expandTag));
  ...
  else if (uu___12_5184[0U] == TLSInfo_ClientApplicationTrafficSecret)
  {
    KRML_CHECK_SIZE(sizeof (TLSInfo_expandTag), (uint32_t)1U);
    TLSInfo_expandTag *buf = KRML_HOST_MALLOC(sizeof (TLSInfo_expandTag));
  ...
  else if (uu___12_5184[0U] == TLSInfo_ServerApplicationTrafficSecret)
  {
    KRML_CHECK_SIZE(sizeof (TLSInfo_expandTag), (uint32_t)1U);
    TLSInfo_expandTag *buf = KRML_HOST_MALLOC(sizeof (TLSInfo_expandTag));
...
TLSInfo_id TLSInfo_peerId(TLSInfo_id uu___13_5204)
{
  if (uu___13_5204.tag == TLSInfo_PlaintextID)
  {
    FStar_Bytes_bytes r = uu___13_5204.val.case_PlaintextID;
    return ((TLSInfo_id){ .tag = TLSInfo_PlaintextID, .val = { .case_PlaintextID = r } });
  }
  else if (uu___13_5204.tag == TLSInfo_ID12)
  {
    TLSConstants_role rw = uu___13_5204.val.case_ID12.writer;
    FStar_Bytes_bytes sr = uu___13_5204.val.case_ID12.sr;
    FStar_Bytes_bytes cr = uu___13_5204.val.case_ID12.cr;
    CipherSuite_aeAlg ae = uu___13_5204.val.case_ID12.aeAlg;
    TLSConstants_prePrfAlg kdf = uu___13_5204.val.case_ID12.kdfAlg;
    TLSInfo_msId msid1 = uu___13_5204.val.case_ID12.msId;
    Parsers_ProtocolVersion_protocolVersion pv = uu___13_5204.val.case_ID12.pv;
    return
      (
        (TLSInfo_id){
          .tag = TLSInfo_ID12,
  ...
  else if (uu___13_5204.tag == TLSInfo_ID13)
  {
    FStar_Bytes_bytes log = uu___13_5204.val.case_ID13->i->_2;
    TLSInfo_expandTag *t = uu___13_5204.val.case_ID13->i->_1;
    TLSInfo_pre_secretId *s = uu___13_5204.val.case_ID13->i->_0;
    TLSInfo_logInfo li = uu___13_5204.val.case_ID13->li;
...
TLSConstants_prePrfAlg TLSInfo_kdfAlg_of_id(TLSInfo_id uu___14_5319)
{
  if (uu___14_5319.tag == TLSInfo_ID12)
    return uu___14_5319.val.case_ID12.kdfAlg;
  else
  {
    KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
      __FILE__,
...
Spec_Hash_Definitions_hash_alg TLSInfo_macAlg_of_id(TLSInfo_id uu___15_5340)
{
  if (uu___15_5340.tag == TLSInfo_ID12)
  {
    CipherSuite_aeAlg ae = uu___15_5340.val.case_ID12.aeAlg;
    Parsers_ProtocolVersion_protocolVersion pv = uu___15_5340.val.case_ID12.pv;
...
K___CipherSuite_encAlg_CipherSuite_ivMode TLSInfo_encAlg_of_id(TLSInfo_id uu___16_5365)
{
  if (uu___16_5365.tag == TLSInfo_ID12)
  {
    CipherSuite_aeAlg ae = uu___16_5365.val.case_ID12.aeAlg;
    Parsers_ProtocolVersion_protocolVersion pv = uu___16_5365.val.case_ID12.pv;
...
CipherSuite_aeAlg TLSInfo_aeAlg_of_id(TLSInfo_id uu___17_5388)
{
  if (uu___17_5388.tag == TLSInfo_ID13)
  {
    TLSInfo_logInfo li = uu___17_5388.val.case_ID13->li;
    return
      (
        (CipherSuite_aeAlg){
  ...
  else if (uu___17_5388.tag == TLSInfo_ID12)
    return uu___17_5388.val.case_ID12.aeAlg;
  else
  {
    KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
      __FILE__,
