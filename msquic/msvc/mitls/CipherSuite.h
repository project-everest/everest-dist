...
#ifndef __CipherSuite_H
#define __CipherSuite_H
...
#define CipherSuite_RSASIG 0
#define CipherSuite_DSA 1
#define CipherSuite_ECDSA 2
#define CipherSuite_RSAPSS 3

typedef uint8_t CipherSuite_sigAlg;
...
#define CipherSuite_Kex_RSA 0
#define CipherSuite_Kex_DH 1
#define CipherSuite_Kex_PSK 2
#define CipherSuite_Kex_PSK_DHE 3
#define CipherSuite_Kex_PSK_ECDHE 4
#define CipherSuite_Kex_DHE 5
#define CipherSuite_Kex_ECDHE 6

typedef uint8_t CipherSuite_kexAlg;
...
typedef EverCrypt_block_cipher_alg CipherSuite_blockCipher;

typedef EverCrypt_stream_cipher_alg CipherSuite_streamCipher;

typedef EverCrypt_aead_alg CipherSuite_aeadAlg;

#define CipherSuite_Fresh 0
#define CipherSuite_Stale 1

typedef uint8_t CipherSuite_ivMode;

bool CipherSuite_uu___is_Fresh(CipherSuite_ivMode projectee);

bool CipherSuite_uu___is_Stale(CipherSuite_ivMode projectee);

#define CipherSuite_Block 0
#define CipherSuite_Stream 1

typedef uint8_t CipherSuite_encAlg_tags;

typedef struct CipherSuite_encAlg_s
{
  CipherSuite_encAlg_tags tag;
  union {
    EverCrypt_block_cipher_alg case_Block;
    EverCrypt_stream_cipher_alg case_Stream;
  }
  val;
}
CipherSuite_encAlg;
...
typedef Spec_Hash_Definitions_hash_alg CipherSuite_hash_alg;

typedef Hashing_Spec_tls_alg CipherSuite_hashAlg;

typedef Spec_Hash_Definitions_hash_alg CipherSuite_macAlg;

extern uint32_t (*CipherSuite_hashSize)(Hashing_Spec_tls_alg x0);
...
#define CipherSuite_MACOnly 0
#define CipherSuite_MtE 1
#define CipherSuite_AEAD 2

typedef uint8_t CipherSuite_aeAlg_tags;

typedef struct CipherSuite_aeAlg_s
{
  CipherSuite_aeAlg_tags tag;
  union {
    Spec_Hash_Definitions_hash_alg case_MACOnly;
    struct 
    {
      CipherSuite_encAlg _0;
      Spec_Hash_Definitions_hash_alg _1;
    }
    case_MtE;
    struct 
    {
      EverCrypt_aead_alg _0;
      Spec_Hash_Definitions_hash_alg _1;
    }
    case_AEAD;
  }
...
typedef struct FStar_Pervasives_Native_option__CipherSuite_sigAlg_s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  CipherSuite_sigAlg v;
}
FStar_Pervasives_Native_option__CipherSuite_sigAlg;

#define CipherSuite_NullCipherSuite 0
#define CipherSuite_CipherSuite 1
#define CipherSuite_CipherSuite13 2
#define CipherSuite_SCSV 3

typedef uint8_t CipherSuite_cipherSuite__tags;

typedef struct CipherSuite_cipherSuite__s
{
  CipherSuite_cipherSuite__tags tag;
  union {
    struct 
    {
      CipherSuite_kexAlg _0;
      FStar_Pervasives_Native_option__CipherSuite_sigAlg _1;
      CipherSuite_aeAlg _2;
    }
    case_CipherSuite;
    struct 
    {
...
CipherSuite_aeAlg
CipherSuite___proj__CipherSuite__item___2(CipherSuite_cipherSuite_ projectee);
...
typedef Parsers_CipherSuite_cipherSuite CipherSuite_cipherSuiteName;

typedef struct FStar_Pervasives_Native_option__CipherSuite_cipherSuite__s
{
  FStar_Pervasives_Native_option__Prims_string_tags tag;
  CipherSuite_cipherSuite_ v;
}
...
typedef struct
FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Parsers_CipherSuite_cipherSuite_s
{
  ...
  union {
    ...
    Parsers_CipherSuite_cipherSuite case_Correct;
  }
  val;
}
...
typedef CipherSuite_cipherSuite_ CipherSuite_cipherSuite;

typedef CipherSuite_cipherSuite_ CipherSuite_valid_cipher_suite;

typedef struct Prims_list__CipherSuite_cipherSuite__s Prims_list__CipherSuite_cipherSuite_;

typedef struct Prims_list__CipherSuite_cipherSuite__s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  CipherSuite_cipherSuite_ hd;
  Prims_list__CipherSuite_cipherSuite_ *tl;
}
Prims_list__CipherSuite_cipherSuite_;

typedef Prims_list__CipherSuite_cipherSuite_ *CipherSuite_cipherSuites;

typedef Prims_list__CipherSuite_cipherSuite_ *CipherSuite_valid_cipher_suites;
...
typedef struct Prims_list__Parsers_CipherSuite_cipherSuite_s
Prims_list__Parsers_CipherSuite_cipherSuite;

typedef struct Prims_list__Parsers_CipherSuite_cipherSuite_s
{
  Prims_list__Parsers_NamedGroup_namedGroup_tags tag;
  Parsers_CipherSuite_cipherSuite hd;
  Prims_list__Parsers_CipherSuite_cipherSuite *tl;
}
Prims_list__Parsers_CipherSuite_cipherSuite;
...
*CipherSuite_nameList_of_cipherSuites_aux(
  ...
  Prims_list__Parsers_CipherSuite_cipherSuite *accu0
);
...
extern Prims_string CipherSuite_parse_cipherSuiteName_error_msg;

Parsers_CipherSuite_cipherSuite CipherSuite_parseCipherSuiteName(FStar_Bytes_bytes x);

#define __CipherSuite_H_DEFINED
#endif
