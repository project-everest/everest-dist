...
Old_HMAC_UFCMA_matches(
  ...
  Old_HMAC_UFCMA_entry uu____1059
)
{
  FStar_Bytes_bytes p_ = uu____1059.p;
...
FStar_List_Tot_Base_index__Old_HMAC_UFCMA_entry(
  Prims_list__Old_HMAC_UFCMA_entry *l0,
  Prims_int i0
)
{
  Prims_list__Old_HMAC_UFCMA_entry *l = l0;
  Prims_int i = i0;
  while (true)
    ...
    {
      l = FStar_List_Tot_Base_tl__Old_HMAC_UFCMA_entry(l);
...
typedef struct Old_KeySchedule_recordInstance_s
{
  ...
  StAE_state r;
  StAE_state w;
  K___FStar_Pervasives_Native_option__FStar_Bytes_bytes_FStar_Pervasives_Native_option__FStar_Bytes_bytes
  _3;
}
...
)
{
  ...
  (
    ...
    == Old_KeySchedule_C
    &&
      scrut.val.case_C.tag
      == Old_KeySchedule_C_13_wait_SH
      && scrut.val.case_C.val.case_C_13_wait_SH.esl->tag == Prims_Nil
  )
  {
    Prims_list__Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare_
...
Old_KeySchedule_ks_client_13_ch(Old_KeySchedule_ks ks, FStar_Bytes_bytes log1)
{
  ...
  )
  {
    ...
    Old_KeySchedule_recordInstance
    early_d = { .id = id1, .r = r, .w = rw, ._3 = { .fst = pn, .snd = pn } };
    return
      (
        (K___FStar_Pervasives_dtuple3__TLSInfo_logInfo_TLSInfo_pre_exportId_FStar_Bytes_bytes_Old_KeySchedule_recordInstance){
          .fst = exporter0,
...
FStar_List_Tot_Base_nth__Prims_dtuple2_TLSInfo_pre_esId_FStar_Bytes_bytes(
  Prims_list__Prims_dtuple2__TLSInfo_pre_esId_FStar_Bytes_bytes *l0,
  Prims_int n0
)
{
  Prims_list__Prims_dtuple2__TLSInfo_pre_esId_FStar_Bytes_bytes *l = l0;
  Prims_int n = n0;
  while (true)
    if (l->tag == Prims_Nil)
      return
    ...
    else if (l->tag == Prims_Cons)
    {
      ...
      {
        l = tl1;
        n = Prims_op_Subtraction(n, (krml_checked_int_t)1);
      }
    }
    else
      return
        KRML_EABORT(FStar_Pervasives_Native_option__Prims_dtuple2__TLSInfo_pre_esId_FStar_Bytes_bytes,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
List_Helpers_find_aux__Prims_dtuple2_CommonDH_group__CommonDH_pre_keyshare__CommonDH_group_(
  ...
  bool (*f0)(CommonDH_group_ x0, Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare_ x1),
  Prims_list__Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare_ *l0
)
{
  CommonDH_group_ env = env0;
  bool (*f)(CommonDH_group_ x0, Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare_ x1) = f0;
  Prims_list__Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return
        (
    ...
    else if (l->tag == Prims_Cons)
    {
      ...
      return
        KRML_EABORT(FStar_Pervasives_Native_option__Prims_dtuple2__CommonDH_group__CommonDH_pre_keyshare_,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
    ...
    return
      (
        (K___Prims_dtuple2__TLSInfo_pre_finishedId_Old_HMAC_UFCMA_key_Prims_dtuple2__TLSInfo_pre_finishedId_Old_HMAC_UFCMA_key_Old_KeySchedule_recordInstance_FStar_Pervasives_dtuple3__TLSInfo_logInfo_TLSInfo_pre_exportId_FStar_Bytes_bytes){
          .fst = sfk,
          .snd = cfk,
          .thd = { .id = id1, .r = r, .w = w, ._3 = { .fst = spn, .snd = cpn } },
          .f3 = exporter1
        }
      );
  }
  ...
  if (scrut0.tag == Old_KeySchedule_S && scrut0.val.case_S.tag == Old_KeySchedule_S_13_wait_SF)
  {
    ...
    *scrut0 = FStar_Pervasives_dfst__TLSInfo_pre_finishedId_Old_HMAC_UFCMA_key(cfk);
    ...
    return
      (
        (K___Old_KeySchedule_recordInstance_FStar_Pervasives_dtuple3__TLSInfo_logInfo_TLSInfo_pre_exportId_FStar_Bytes_bytes){
          .fst = { .id = id1, .r = r, .w = w, ._3 = { .fst = cpn, .snd = spn } },
          .snd = exporter1
        }
      );
  }
...
Old_KeySchedule_ks_client_12_full_dh(
  ...
  CipherSuite_cipherSuite_ cs,
  bool ems,
  Prims_dtuple2__CommonDH_group__CommonDH_pre_share_ uu____16094
)
{
  CommonDH_group_ g1 = uu____16094.fst;
  CommonDH_pre_share_ gx = uu____16094.snd;
  Old_KeySchedule_ks_state *st = ks.state;
  Old_KeySchedule_ks_state scrut0 = st[0U];
  FStar_Bytes_bytes cr;
...
typedef struct
FStar_Pervasives_dtuple3__FStar_Seq_Base_seq__Old_Epochs_epoch__Prims_int__Prims_int__s
{
  Prims_list__Old_Epochs_epoch **_1;
  Prims_int *_2;
  Prims_int *_3;
}
FStar_Pervasives_dtuple3__FStar_Seq_Base_seq__Old_Epochs_epoch__Prims_int__Prims_int_;

static FStar_Pervasives_dtuple3__FStar_Seq_Base_seq__Old_Epochs_epoch__Prims_int__Prims_int_
...
static void
Old_Epochs_add_epoch(FStar_Bytes_bytes n1, Old_Epochs_epochs uu____44935, Old_Epochs_epoch e)
{
  Prims_list__Old_Epochs_epoch **es = uu____44935.es;
...
static Old_Epochs_epoch
FStar_List_Tot_Base_index__Old_Epochs_epoch(Prims_list__Old_Epochs_epoch *l0, Prims_int i0)
{
  Prims_list__Old_Epochs_epoch *l = l0;
  Prims_int i = i0;
  while (true)
    if (i == (krml_checked_int_t)0)
    ...
    {
      l = FStar_List_Tot_Base_tl__Old_Epochs_epoch(l);
      i = Prims_op_Subtraction(i, (krml_checked_int_t)1);
    }
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
...
static Prims_string Old_Handshake_iutf8(FStar_Bytes_bytes m0)
{
  FStar_Bytes_bytes m = m0;
  while (true)
  {
...
FStar_List_Tot_Base_nth__FStar_Bytes_bytes(Prims_list__FStar_Bytes_bytes *l0, Prims_int n0)
{
  Prims_list__FStar_Bytes_bytes *l = l0;
  Prims_int n = n0;
  while (true)
    if (l->tag == Prims_Nil)
      return
...
TLSConstants_fold_string__FStar_Bytes_bytes(
  Prims_string (*f0)(FStar_Bytes_bytes x0),
  Prims_string accum0,
  Prims_string sep0,
  Prims_list__FStar_Bytes_bytes *al0
)
{
  Prims_string (*f)(FStar_Bytes_bytes x0) = f0;
  Prims_string accum = accum0;
  Prims_string sep = sep0;
...
Old_Handshake_recv_fragment(
  Old_Handshake_hs_ hs0,
  TLSInfo_id i10,
  K___Prims_int_Prims_int rg10,
  FStar_Bytes_bytes f0
)
{
  Old_Handshake_hs_ hs = hs0;
  K___Prims_int_Prims_int rg1 = rg10;
  FStar_Bytes_bytes f = f0;
  while (true)
  {
    ...
    )
    {
      ...
      return
        KRML_EABORT(Old_Handshake_incoming,
          "unreachable (pattern matches are exhaustive in F*)");
  }
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
