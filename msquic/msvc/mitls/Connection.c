...
bool Connection_uu___is_Ctrl(Connection_halfState projectee)
{
  switch (projectee)
  {
...
bool Connection_uu___is_Open(Connection_halfState projectee)
{
  switch (projectee)
  {
...
bool Connection_uu___is_Closed(Connection_halfState projectee)
{
  switch (projectee)
  {
...
Prims_string Connection_string_of_halfState(Connection_halfState uu___0_51)
{
  switch (uu___0_51)
  {
    case Connection_Ctrl:
...
Prims_string Connection_string_of_state(K___Connection_halfState_Connection_halfState uu____68)
{
  Connection_halfState r = uu____68.fst;
  Connection_halfState w = uu____68.snd;
  return
    Prims_strcat(Connection_string_of_halfState(r),
      Prims_strcat("/", Connection_string_of_halfState(w)));
}

bool Connection_uu___is_C(Connection_connection projectee)
{
  return true;
}

Old_Handshake_hs_ Connection___proj__C__item__hs(Connection_connection projectee)
{
  return projectee.hs;
}

Transport_t Connection___proj__C__item__tcp(Connection_connection projectee)
{
  return projectee.tcp;
}

Record_input_state Connection___proj__C__item__recv(Connection_connection projectee)
{
  return projectee.recv;
}

K___Connection_halfState_Connection_halfState
*Connection___proj__C__item__state(Connection_connection projectee)
{
  return projectee.state;
}

TLSConstants_role Connection_c_role(Connection_connection c)
{
  return Old_Handshake_role_of(c.hs);
}

FStar_Bytes_bytes Connection_c_nonce(Connection_connection c)
{
  return Old_Handshake_random_of(c.hs);
}

TLSConstants_config Connection_c_cfg(Connection_connection c)
{
  return Old_Handshake_config_of(c.hs);
}

Old_Epochs_epochs Connection_c_log(Connection_connection c)
{
  return Old_Handshake_epochs_of(c.hs);
}
