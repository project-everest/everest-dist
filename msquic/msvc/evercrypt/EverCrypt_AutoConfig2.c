...
static bool EverCrypt_AutoConfig2_user_wants_openssl[1U] = { false };

static bool EverCrypt_AutoConfig2_user_wants_bcrypt[1U] = { true };
...
void EverCrypt_AutoConfig2_init()
{
  ...
  EverCrypt_AutoConfig2_user_wants_bcrypt[0U] = true;
